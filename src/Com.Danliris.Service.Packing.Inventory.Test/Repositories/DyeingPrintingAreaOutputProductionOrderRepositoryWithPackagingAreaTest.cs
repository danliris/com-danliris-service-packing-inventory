...
{
    public class DyeingPrintingAreaOutputProductionOrderRepositoryWithPackagingAreaTest
        : BaseRepositoryTest<PackingInventoryDbContext, DyeingPrintingAreaOutputProductionOrderRepository, DyeingPrintingAreaOutputProductionOrderModel, DyeingPrintingAreaOutputProductionOrderWithPackagingAreaDataUtil>
    {
        private const string ENTITY = "DyeingPrintingAreaOutputProductionOrder";
        public DyeingPrintingAreaOutputProductionOrderRepositoryWithPackagingAreaTest() : base(ENTITY)
        {
        }
