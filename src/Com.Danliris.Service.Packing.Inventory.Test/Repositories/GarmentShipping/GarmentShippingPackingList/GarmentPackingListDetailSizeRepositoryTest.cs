...
{
    public class GarmentShippingPackingListDetailSizeRepositoryTest : BaseRepositoryTest<PackingInventoryDbContext, GarmentShippingPackingListDetailSizeRepository, GarmentShippingPackingListDetailSizeModel, GarmentShippingPackingListDetailSizeDataUtil>
    {
        private const string ENTITY = "GarmentPackingListDetailSizeRepositoryTest";

        public GarmentShippingPackingListDetailSizeRepositoryTest() : base(ENTITY)
        {
        }
        [Fact]
        public async Task Should_Success_Update_Data()
        {
            ...
            var repo = new GarmentShippingPackingListDetailSizeRepository(dbContext, serviceProvider);
