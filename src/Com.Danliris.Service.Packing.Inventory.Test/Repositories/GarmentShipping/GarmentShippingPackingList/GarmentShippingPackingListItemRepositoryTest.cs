...
{
    public class GarmentShippingPackingListItemRepositoryTest : BaseRepositoryTest<PackingInventoryDbContext, GarmentShippingPackingListItemRepository, GarmentShippingPackingListItemModel, GarmentShippingPackingListItemDataUtil>
    {
        private const string ENTITY = "GarmentPackingListItemRepositoryTest";

        public GarmentShippingPackingListItemRepositoryTest() : base(ENTITY)
        {
        }
        [Fact]
        public async Task Should_Success_Update_Data()
        {
            ...
            var repo = new GarmentShippingPackingListItemRepository(dbContext, serviceProvider);
