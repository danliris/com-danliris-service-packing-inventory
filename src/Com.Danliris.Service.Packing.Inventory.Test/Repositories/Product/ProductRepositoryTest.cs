...
using Com.Danliris.Service.Packing.Inventory.Infrastructure.Repositories.Product.Product;
...
namespace Com.Danliris.Service.Packing.Inventory.Test.Repositories.Product
{
    public class ProductRepositoryTest
    {
        ...
        public async Task Should_Success_Create_New_Data()
        {
            ...
            var productDataUtil = new ProductDataUtil(dbContext);
            var modelToCreate = await productDataUtil.GetModel();

            var repository = new ProductRepository(dbContext, serviceProviderMock.Object);
        ...
        public async Task Should_Success_Read_All_Existing_Data()
        {
            ...
            var productDataUtil = new ProductDataUtil(dbContext);
            await productDataUtil.GetNewData();
        ...
        public async Task Should_Success_Update_Existing_Data()
        {
            ...
            var productDataUtil = new ProductDataUtil(dbContext);
            var modelToUpdate = await productDataUtil.GetNewData();
        ...
        public async Task Should_Success_Delete_Existing_Data()
        {
            ...
            var productDataUtil = new ProductDataUtil(dbContext);
            var modelToDelete = await productDataUtil.GetNewData();
