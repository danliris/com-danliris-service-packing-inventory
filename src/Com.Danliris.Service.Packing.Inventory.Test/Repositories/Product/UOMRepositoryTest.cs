...
using Com.Danliris.Service.Packing.Inventory.Infrastructure.Repositories.Product.UnitOfMeasurement;
...
namespace Com.Danliris.Service.Packing.Inventory.Test.Repositories.Product
{
    ...
    {
        private const string ENTITY = "UOM";
        ...
        public async Task Should_Success_Create_New_Data()
        {
            ...
            var dataUtil = new UOMDataUtil(dbContext);
            var modelToCreate = dataUtil.GetModel();

            var repository = new UOMRepository(dbContext, serviceProviderMock.Object);
