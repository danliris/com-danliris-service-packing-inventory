...
{
    public class TransitAreaNoteServiceTest
    {
        public TransitAreaNoteService GetService(IServiceProvider serviceProvider)
        {
            return new TransitAreaNoteService(serviceProvider);
        }
