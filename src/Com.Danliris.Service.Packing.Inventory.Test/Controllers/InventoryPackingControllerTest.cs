...
{
  public  class InventoryPackingControllerTest
    {
        private InventoryPackingController GetController(IInventoryDocumentPackingService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new InventoryPackingController(service, identityProvider)
            {
        ...
        public async Task Post_Return_Success()
        {
            ...
            serviceMock.Setup(s => s.Create(It.IsAny<CreateInventoryDocumentPackingViewModel>()));
        ...
        public async Task GetById_Return_Success()
        {
            //setup
            var serviceMock = new Mock<IInventoryDocumentPackingService>();
            serviceMock.Setup(s => s.ReadById(It.IsAny<int>())).ReturnsAsync(new InventoryDocumentPackingModel());
            var service = serviceMock.Object;
