...
{
    public class PackingAreaNoteControllerTest
    {
        private PackingAreaNoteController GetController(IPackingAreaNoteService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new PackingAreaNoteController(service, identityProvider)
            {
