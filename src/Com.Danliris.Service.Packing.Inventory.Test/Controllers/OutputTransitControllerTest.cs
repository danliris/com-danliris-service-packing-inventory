...
namespace Com.Danliris.Service.Packing.Inventory.Test.Controllers
{
    ...
    {
        private OutputTransitController GetController(IOutputTransitService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new OutputTransitController(service, identityProvider)
            {
