...
using Com.Danliris.Service.Packing.Inventory.WebApi.Controllers.GarmentShipping.PaymentDispositionEMKL;
...
{
    public class GarmentShippingPaymentDispositionEMKLControllerTest
    {
        protected GarmentShippingPaymentDispositionEMKLController GetController(IGarmentShippingPaymentEMKLDispositionService service, IIdentityProvider identityProvider, IValidateService validateService, IGarmentShippingInvoiceService invoiceService, IGarmentPackingListService packingListService)
        {
            ...
            var controller = new GarmentShippingPaymentDispositionEMKLController(service, identityProvider, validateService, invoiceService, packingListService)
            {
        ...
        protected virtual GarmentShippingPaymentDispositionEMKLViewModel ViewModel
        {
            get
            {
        ...
        public async Task Put_Ok()
        {
            ...
            var serviceMock = new Mock<IGarmentShippingPaymentEMKLDispositionService>();
            serviceMock
                .Setup(s => s.Update(It.IsAny<int>(), It.IsAny<GarmentShippingPaymentDispositionEMKLViewModel>()))
                .ReturnsAsync(1);
            ...
            validateServiceMock
                .Setup(s => s.Validate(It.IsAny<GarmentShippingPaymentDispositionEMKLViewModel>()))
                .Verifiable();
        ...
        public async Task Post_Created()
        {
            ...
            var serviceMock = new Mock<IGarmentShippingPaymentEMKLDispositionService>();
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentShippingPaymentDispositionEMKLViewModel>()))
                .ReturnsAsync(1);
            var service = serviceMock.Object;
            var invoiceServiceMock = new Mock<IGarmentShippingInvoiceService>();
            var invoiceService = invoiceServiceMock.Object;
        ...
        public void Get_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<GarmentShippingPaymentDispositionEMKLViewModel>(new List<GarmentShippingPaymentDispositionEMKLViewModel>(), 1, 1, 1));
            var service = serviceMock.Object;
            var invoiceServiceMock = new Mock<IGarmentShippingInvoiceService>();
            var invoiceService = invoiceServiceMock.Object;
        ...
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingPaymentDispositionEMKLViewModel());
            var service = serviceMock.Object;
            var invoiceServiceMock = new Mock<IGarmentShippingInvoiceService>();
            var invoiceService = invoiceServiceMock.Object;
