...
{
    public class GarmentFinanceExportSalesJournalControllerTest
    {
        protected GarmentFinanceExportSalesJournalController GetController(IGarmentFinanceExportSalesJournalService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentFinanceExportSalesJournalController(service, identityProvider)
            {
