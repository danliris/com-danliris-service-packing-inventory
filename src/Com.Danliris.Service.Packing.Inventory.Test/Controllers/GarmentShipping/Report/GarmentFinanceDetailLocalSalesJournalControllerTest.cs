...
{
    public class GarmentFinanceDetailLocalSalesJournalControllerTest
    {
        protected GarmentFinanceDetailLocalSalesJournalController GetController(IGarmentFinanceDetailLocalSalesJournalService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentFinanceDetailLocalSalesJournalController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentFinanceDetailLocalSalesJournalService>();
            serviceMock
