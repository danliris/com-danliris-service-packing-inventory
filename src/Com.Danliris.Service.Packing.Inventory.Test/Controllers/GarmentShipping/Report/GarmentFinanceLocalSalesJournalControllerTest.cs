...
{
    public class GarmentFinanceLocalSalesJournalControllerTest
    {
        protected GarmentFinanceLocalSalesJournalController GetController(IGarmentFinanceLocalSalesJournalService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentFinanceLocalSalesJournalController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentFinanceLocalSalesJournalService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentFinanceLocalSalesJournalViewModel>());
