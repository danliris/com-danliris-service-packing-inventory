...
{
    public class GarmentShippingLocalPriceCorrectionNoteControllerGetByIdTest : GarmentShippingLocalPriceCorrectionNoteControllerTest
    {
        [Fact]
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingLocalPriceCorrectionNoteViewModel());
