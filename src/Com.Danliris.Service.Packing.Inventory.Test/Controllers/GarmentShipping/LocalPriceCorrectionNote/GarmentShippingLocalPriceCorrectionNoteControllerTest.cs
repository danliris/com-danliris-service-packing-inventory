...
{
    public class GarmentShippingLocalPriceCorrectionNoteControllerTest
    {
        protected GarmentShippingLocalPriceCorrectionNoteController GetController(IGarmentShippingLocalPriceCorrectionNoteService service, IIdentityProvider identityProvider, IValidateService validateService)
        {
            ...
            var controller = new GarmentShippingLocalPriceCorrectionNoteController(service, identityProvider, validateService)
            {
        ...
        protected virtual GarmentShippingLocalPriceCorrectionNoteViewModel ViewModel
        {
            get
            {
