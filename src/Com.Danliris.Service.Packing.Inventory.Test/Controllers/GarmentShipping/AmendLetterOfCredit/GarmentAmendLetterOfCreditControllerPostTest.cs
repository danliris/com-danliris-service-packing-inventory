...
{
    public class GarmentAmendLetterOfCreditControllerPostTest : GarmentAmendLetterOfCreditControllerTest
    {
        [Fact]
        public async Task Post_Created()
        {
            ...
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentAmendLetterOfCreditViewModel>()))
                .ReturnsAsync(1);
