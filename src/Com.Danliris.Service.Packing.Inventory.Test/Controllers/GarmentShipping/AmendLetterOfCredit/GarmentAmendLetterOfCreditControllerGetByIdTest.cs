...
{
    public class GarmentAmendLetterOfCreditControllerGetByIdTest : GarmentAmendLetterOfCreditControllerTest
    {
        [Fact]
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentAmendLetterOfCreditViewModel());
