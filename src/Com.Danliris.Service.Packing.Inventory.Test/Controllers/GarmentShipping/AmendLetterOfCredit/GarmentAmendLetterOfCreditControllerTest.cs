...
using Com.Danliris.Service.Packing.Inventory.WebApi.Controllers.GarmentShipping.GarmentAmendLetterOfCredit;
...
{
    public class GarmentAmendLetterOfCreditControllerTest
    {
        ...
        protected virtual GarmentAmendLetterOfCreditViewModel ViewModel
        {
            get
            {
