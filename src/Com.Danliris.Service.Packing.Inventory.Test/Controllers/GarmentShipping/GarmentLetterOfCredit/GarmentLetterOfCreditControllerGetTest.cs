...
{
    public class GarmentLetterOfCreditControllerGetTest : GarmentLetterOfCreditControllerTest
    {
        [Fact]
        public void Get_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<GarmentLetterOfCreditViewModel>(new List<GarmentLetterOfCreditViewModel>(), 1, 1, 1));
