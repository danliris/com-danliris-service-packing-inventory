...
{
    public class GarmentShippingLocalSalesNoteControllerPostTest : GarmentShippingLocalSalesNoteControllerTest
    {
        [Fact]
        public async Task Post_Created()
        {
            ...
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentShippingLocalSalesNoteViewModel>()))
                .ReturnsAsync(1);
