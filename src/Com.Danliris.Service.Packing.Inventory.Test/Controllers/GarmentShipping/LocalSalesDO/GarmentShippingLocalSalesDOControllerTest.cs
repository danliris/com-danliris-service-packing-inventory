...
{
    public class GarmentShippingLocalSalesDOControllerTest
    {
        ...
        protected virtual GarmentShippingLocalSalesDOViewModel ViewModel
        {
            get
            {
        ...
        public async Task Put_Ok()
        {
            ...
            serviceMock
                .Setup(s => s.Update(It.IsAny<int>(), It.IsAny<GarmentShippingLocalSalesDOViewModel>()))
                .ReturnsAsync(1);
        ...
        public async Task Post_Created()
        {
            ...
            var serviceMock = new Mock<IGarmentShippingLocalSalesDOService>();
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentShippingLocalSalesDOViewModel>()))
                .ReturnsAsync(1);
            var service = serviceMock.Object;
        ...
        public void Get_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<GarmentShippingLocalSalesDOViewModel>(new List<GarmentShippingLocalSalesDOViewModel>(), 1, 1, 1));
            var service = serviceMock.Object;
        ...
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingLocalSalesDOViewModel());
            var service = serviceMock.Object;
