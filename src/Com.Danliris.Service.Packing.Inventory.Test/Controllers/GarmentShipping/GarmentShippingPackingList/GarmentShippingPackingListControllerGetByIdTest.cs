...
{
    public class GarmentShippingPackingListControllerGetByIdTest : GarmentShippingPackingListControllerTest
    {
        [Fact]
        ...
        [Fact]
        public async Task GetWHPdfById_Ok()
        {
            var serviceMock = new Mock<IGarmentShippingPackingListService>();
            serviceMock
                .Setup(s => s.ReadWHPdfById(It.IsAny<int>()))
                .ReturnsAsync(new MemoryStreamResult(new MemoryStream(), "FileName.pdf"));
            var service = serviceMock.Object;
            ...
            var controller = GetController(service, identityProvider, validateService);
            controller.ControllerContext.HttpContext.Request.Headers["Accept"] = "application/pdf";
            var response = await controller.GetWHById(1);
        ...
        public async Task GetPdfByOrderNo_Ok()
        {
            var serviceMock = new Mock<IGarmentShippingPackingListService>();
            serviceMock
                .Setup(s => s.ReadPdfByOrderNo(It.IsAny<int>()))
                .ReturnsAsync(new MemoryStreamResult(new MemoryStream(), "FileName.pdf"));
            var service = serviceMock.Object;
            ...
            var controller = GetController(service, identityProvider, validateService);
            controller.ControllerContext.HttpContext.Request.Headers["Accept"] = "application/pdf";
            var response = await controller.GetByOrderNo(1);

            Assert.NotNull(response);
        }

        [Fact]
        public async Task GetWHPdfByOrderNo_Ok()
        {
            var serviceMock = new Mock<IGarmentShippingPackingListService>();
            serviceMock
                .Setup(s => s.ReadWHPdfByOrderNo(It.IsAny<int>()))
                .ReturnsAsync(new MemoryStreamResult(new MemoryStream(), "FileName.pdf"));
            var service = serviceMock.Object;
        ...
        //[Fact]
        //public async Task GetXlsByIdFilterCarton_Ok()
        //{
        //    var serviceMock = new Mock<IGarmentShippingPackingListService>();
        //    serviceMock
        //        .Setup(s => s.ReadExcelByIdFilterCarton(It.IsAny<int>()))
        //        .ReturnsAsync(new MemoryStreamResult(new MemoryStream(), "FileName.xls"));
        //    var service = serviceMock.Object;
        ...
        [Fact]
        public async Task GetWHById_Exception_InternalServerError()
        {
            var dataUtil = GetViewModel();
        ...
        [Fact]
        public async Task GetWHByOrderNo_Exception_InternalServerError()
        {
            var dataUtil = GetViewModel();
        ...
        [Fact]
        public async Task GetOrderNo_Exception_InternalServerError()
        {
            var dataUtil = GetViewModel();
