...
{
    public class GarmentShippingPackingListControllerTest
    {
        protected GarmentShippingPackingListController GetController(IGarmentShippingPackingListService service, IIdentityProvider identityProvider, IValidateService validateService)
        {
            ...
            var controller = new GarmentShippingPackingListController(service, identityProvider, validateService)
            {
        ...
        protected virtual GarmentShippingPackingListViewModel GetViewModel()
        {
