...
{
    public class GarmentCreditNoteMonitoringControllerTest
    {
        protected GarmenCreditNoteMonitoringController GetController(IGarmentCreditNoteMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenCreditNoteMonitoringController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentCreditNoteMonitoringService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentCreditNoteMonitoringViewModel>());
