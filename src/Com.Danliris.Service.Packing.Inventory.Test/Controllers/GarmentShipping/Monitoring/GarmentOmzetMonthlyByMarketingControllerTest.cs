...
{
    public class GarmentOmzetMonthlyByMarketingControllerTest
    {
        protected GarmenOmzetMonthlyByMarketingController GetController(IGarmentOmzetMonthlyByMarketingService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenOmzetMonthlyByMarketingController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentOmzetMonthlyByMarketingService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentOmzetMonthlyByMarketingViewModel>());
