...
{
    public class GarmentPaymentDispositionRecapReportControllerTest
    {
        protected GarmentPaymentDispositionRecapReportController GetController(IGarmentPaymentDispositionRecapReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentPaymentDispositionRecapReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentPaymentDispositionRecapReportService>();
            _ = serviceMock
                .Setup(s => s.GetReportData(It.IsAny<String>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                 .Returns(new List<GarmentPaymentDispositionRecapReportViewModel>());
