...
{
    public class GarmentPaymentDispositionReportControllerTest
    {
        protected GarmentPaymentDispositionReportController GetController(IGarmentPaymentDispositionReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentPaymentDispositionReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentPaymentDispositionReportService>();
            _ = serviceMock
                .Setup(s => s.GetReportData(It.IsAny<String>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                 .Returns(new List<GarmentPaymentDispositionReportViewModel>());
