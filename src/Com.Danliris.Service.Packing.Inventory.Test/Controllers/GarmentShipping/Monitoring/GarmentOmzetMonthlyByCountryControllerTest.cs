...
{
    public class GarmentOmzetMonthlyByCountryControllerTest
    {
        protected GarmenOmzetMonthlyByCountryController GetController(IGarmentOmzetMonthlyByCountryService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenOmzetMonthlyByCountryController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentOmzetMonthlyByCountryService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentOmzetMonthlyByCountryViewModel>());
