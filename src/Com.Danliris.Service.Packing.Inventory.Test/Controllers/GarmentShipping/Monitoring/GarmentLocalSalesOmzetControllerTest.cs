...
{
    public class GarmentLocalSalesOmzetControllerTest
    {
        protected GarmenLocalSalesOmzetController GetController(IGarmentLocalSalesOmzetService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenLocalSalesOmzetController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentLocalSalesOmzetService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentLocalSalesOmzetViewModel>());
