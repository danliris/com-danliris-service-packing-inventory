...
{
    public class GarmentOmzetMonthlyByBuyerControllerTest
    {
        protected GarmenOmzetMonthlyByBuyerController GetController(IGarmentOmzetMonthlyByBuyerService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenOmzetMonthlyByBuyerController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentOmzetMonthlyByBuyerService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentOmzetMonthlyByBuyerViewModel>());
