...
{
    public class GarmentShipmentMonitoringControllerTest
    {
        protected GarmentShipmentMonitoringController GetController(IGarmentShipmentMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentShipmentMonitoringController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentShipmentMonitoringService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentShipmentMonitoringViewModel>());
