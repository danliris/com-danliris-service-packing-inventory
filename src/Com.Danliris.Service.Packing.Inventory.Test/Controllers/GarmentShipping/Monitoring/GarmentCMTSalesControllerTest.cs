...
{
    public class GarmentCMTSalesControllerTest
    {
        protected GarmentCMTSalesReportController GetController(IGarmentCMTSalesService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentCMTSalesReportController(service, identityProvider)
            {
