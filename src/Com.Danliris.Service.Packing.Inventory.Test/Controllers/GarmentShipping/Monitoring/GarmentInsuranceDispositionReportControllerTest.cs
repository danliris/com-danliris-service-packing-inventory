...
{
    public class GarmentInsuranceDispositionReportControllerTest
    {
        protected GarmentInsuranceDispositionReportController GetController(IGarmentInsuranceDispositionReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentInsuranceDispositionReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentInsuranceDispositionReportService>();
            _ = serviceMock
                .Setup(s => s.GetReportData(It.IsAny<String>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                 .Returns(new List<GarmentInsuranceDispositionReportViewModel>());
