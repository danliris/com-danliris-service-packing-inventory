...
{
    public class GarmentLetterOfCreditMonitoringControllerTest
    {
        protected GarmentLetterOfCreditMonitoringController GetController(IGarmentLetterOfCreditMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentLetterOfCreditMonitoringController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentLetterOfCreditMonitoringService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentLetterOfCreditMonitoringViewModel>());
