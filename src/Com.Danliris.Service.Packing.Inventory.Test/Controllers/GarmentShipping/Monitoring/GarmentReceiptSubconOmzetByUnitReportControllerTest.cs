...
{
    public class GarmentReceiptSubconOmzetByUnitReportControllerTest
    {
        protected GarmentReceiptSubconOmzetByUnitReportController GetController(IGarmentReceiptSubconOmzetByUnitReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentReceiptSubconOmzetByUnitReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentReceiptSubconOmzetByUnitReportService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new ListResult<GarmentReceiptSubconOmzetByUnitReportViewModel>(new List<GarmentReceiptSubconOmzetByUnitReportViewModel>() { new GarmentReceiptSubconOmzetByUnitReportViewModel() }, 1, 1, 1));
