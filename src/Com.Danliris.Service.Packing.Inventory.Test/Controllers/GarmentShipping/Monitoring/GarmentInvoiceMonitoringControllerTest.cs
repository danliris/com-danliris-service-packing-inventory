...
{
    public class GarmentInvoiceMonitoringControllerTest
    {
        protected GarmenInvoiceMonitoringController GetController(IGarmentInvoiceMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenInvoiceMonitoringController(service, identityProvider)
            {
        ...
        public void GetReportData_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new List<GarmentInvoiceMonitoringViewModel>());
