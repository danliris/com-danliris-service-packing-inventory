...
{
    public class GarmentDetailOmzetByUnitReportControllerTest
    {
        protected GarmentDetailOmzetByUnitReportController GetController(IGarmentDetailOmzetByUnitReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentDetailOmzetByUnitReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentDetailOmzetByUnitReportService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new ListResult<GarmentDetailOmzetByUnitReportViewModel>(new List<GarmentDetailOmzetByUnitReportViewModel>() { new GarmentDetailOmzetByUnitReportViewModel() }, 1, 1, 1));
