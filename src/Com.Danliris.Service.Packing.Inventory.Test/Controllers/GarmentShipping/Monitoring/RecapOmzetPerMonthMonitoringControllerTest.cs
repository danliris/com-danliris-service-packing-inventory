...
{
    public class RecapOmzetPerMonthMonitoringControllerTest
    {
        protected RecapOmzetPerMonthMonitoringController GetController(IRecapOmzetPerMonthMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new RecapOmzetPerMonthMonitoringController(service, identityProvider)
            {
        ...
        public void GetReportData_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<RecapOmzetPerMonthMonitoringViewModel>(new List<RecapOmzetPerMonthMonitoringViewModel>() { new RecapOmzetPerMonthMonitoringViewModel() }, 1, 1, 1));
