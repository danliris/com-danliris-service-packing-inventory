...
{
    public class GarmentInvoiceHistoryMonitoringControllerTest
    {
        protected GarmentInvoiceHistoryMonitoringController GetController(IGarmentInvoiceHistoryMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentInvoiceHistoryMonitoringController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentInvoiceHistoryMonitoringService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentInvoiceHistoryMonitoringViewModel>());
