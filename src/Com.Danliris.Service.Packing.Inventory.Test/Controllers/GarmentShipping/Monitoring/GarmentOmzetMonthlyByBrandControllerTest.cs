...
{
    public class GarmentOmzetMonthlyByBrandControllerTest
    {
        protected GarmenOmzetMonthlyByBrandController GetController(IGarmentOmzetMonthlyByBrandService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenOmzetMonthlyByBrandController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentOmzetMonthlyByBrandService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentOmzetMonthlyByBrandViewModel>());
