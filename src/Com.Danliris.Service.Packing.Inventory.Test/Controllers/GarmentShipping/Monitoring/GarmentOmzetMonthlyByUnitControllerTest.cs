...
{
    public class GarmentOmzetMonthlyByUnitControllerTest
    {
        protected GarmenOmzetMonthlyByUnitController GetController(IGarmentOmzetMonthlyByUnitService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenOmzetMonthlyByUnitController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentOmzetMonthlyByUnitService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentOmzetMonthlyByUnitViewModel>());
