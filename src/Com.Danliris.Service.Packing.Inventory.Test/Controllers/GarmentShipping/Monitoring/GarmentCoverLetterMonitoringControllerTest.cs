...
{
    public class GarmentCoverLetterMonitoringControllerTest
    {
        protected GarmentCoverLetterMonitoringController GetController(IGarmentCoverLetterMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentCoverLetterMonitoringController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentCoverLetterMonitoringService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentCoverLetterMonitoringViewModel>());
