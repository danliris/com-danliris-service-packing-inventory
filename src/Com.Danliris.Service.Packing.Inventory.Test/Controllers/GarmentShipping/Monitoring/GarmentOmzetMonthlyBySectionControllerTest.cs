...
{
    public class GarmentOmzetMonthlyBySectionControllerTest
    {
        protected GarmenOmzetMonthlyBySectionController GetController(IGarmentOmzetMonthlyBySectionService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenOmzetMonthlyBySectionController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentOmzetMonthlyBySectionService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentOmzetMonthlyBySectionViewModel>());
