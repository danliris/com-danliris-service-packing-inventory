...
{
    public class GarmentRecapOmzetReportControllerTest
    {
        protected GarmentRecapOmzetReportController GetController(IGarmentRecapOmzetReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentRecapOmzetReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentRecapOmzetReportService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new ListResult<GarmentRecapOmzetReportViewModel>(new List<GarmentRecapOmzetReportViewModel>() { new GarmentRecapOmzetReportViewModel() }, 1, 1, 1));
