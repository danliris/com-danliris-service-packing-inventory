...
{
    public class GarmentShippingInstructionMonitoringControllerTest
    {
        protected GarmentShippingInstructionMonitoringController GetController(IGarmentShippingInstructionMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentShippingInstructionMonitoringController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentShippingInstructionMonitoringService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentShippingInstructionMonitoringViewModel>());
