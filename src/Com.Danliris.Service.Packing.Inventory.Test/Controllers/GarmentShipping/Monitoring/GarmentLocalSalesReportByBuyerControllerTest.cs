...
{
    public class GarmentLocalSalesReportByBuyerControllerTest
    {
        protected GarmenLocalSalesReportByBuyerController GetController(IGarmentLocalSalesReportByBuyerService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenLocalSalesReportByBuyerController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentLocalSalesReportByBuyerService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentLocalSalesReportByBuyerViewModel>());
