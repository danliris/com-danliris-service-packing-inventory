...
{
    public class GarmentOmzetMonthlyByComodityControllerTest
    {
        protected GarmenOmzetMonthlyByComodityController GetController(IGarmentOmzetMonthlyByComodityService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmenOmzetMonthlyByComodityController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentOmzetMonthlyByComodityService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<GarmentOmzetMonthlyByComodityViewModel>());
