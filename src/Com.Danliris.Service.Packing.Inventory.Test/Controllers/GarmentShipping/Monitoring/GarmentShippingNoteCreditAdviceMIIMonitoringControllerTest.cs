...
{
    public class GarmentShippingNoteCreditAdviceMIIMonitoringControllerTest
    {
        protected GarmentShippingNoteCreditAdviceMIIMonitoringController GetController(IGarmentShippingNoteCreditAdviceMIIMonitoringService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new GarmentShippingNoteCreditAdviceMIIMonitoringController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IGarmentShippingNoteCreditAdviceMIIMonitoringService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new ListResult<GarmentShippingNoteCreditAdviceMIIMonitoringViewModel>(new List<GarmentShippingNoteCreditAdviceMIIMonitoringViewModel>() { new GarmentShippingNoteCreditAdviceMIIMonitoringViewModel() }, 1, 1, 1));
