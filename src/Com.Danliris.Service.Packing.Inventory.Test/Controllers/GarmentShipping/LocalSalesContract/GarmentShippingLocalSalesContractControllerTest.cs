...
{
    public class GarmentShippingLocalSalesContractControllerTest
    {
        ...
        public async Task Put_Ok()
        {
            ...
            serviceMock
                .Setup(s => s.Update(It.IsAny<int>(), It.IsAny<GarmentShippingLocalSalesContractViewModel>()))
                .ReturnsAsync(1);
        ...
        public async Task Post_Created()
        {
            ...
            var serviceMock = new Mock<IGarmentShippingLocalSalesContractService>();
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentShippingLocalSalesContractViewModel>()))
                .ReturnsAsync(1);
            var service = serviceMock.Object;
        ...
        public void Get_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<GarmentShippingLocalSalesContractViewModel>(new List<GarmentShippingLocalSalesContractViewModel>(), 1, 1, 1));
            var service = serviceMock.Object;
        ...
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingLocalSalesContractViewModel());
            var service = serviceMock.Object;
