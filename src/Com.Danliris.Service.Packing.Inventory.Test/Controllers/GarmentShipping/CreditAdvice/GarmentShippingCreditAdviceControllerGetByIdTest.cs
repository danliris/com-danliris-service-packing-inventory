...
{
    public class GarmentShippingCreditAdviceControllerGetByIdTest : GarmentShippingCreditAdviceControllerTest
    {
        [Fact]
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingCreditAdviceViewModel());
