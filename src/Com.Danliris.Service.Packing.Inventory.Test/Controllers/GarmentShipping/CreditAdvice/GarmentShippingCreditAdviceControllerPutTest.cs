...
{
    public class GarmentShippingCreditAdviceControllerPutTest : GarmentShippingCreditAdviceControllerTest
    {
        [Fact]
        public async Task Put_Ok()
        {
            ...
            serviceMock
                .Setup(s => s.Update(It.IsAny<int>(), It.IsAny<GarmentShippingCreditAdviceViewModel>()))
                .ReturnsAsync(1);
