...
{
    public class GarmentPackingListControllerSetRevisedShippingTest : GarmentPackingListControllerTest
    {
        [Fact]
        public async Task Set_RevisedShipping_Success()
        {
            ...
            serviceMock
                .Setup(s => s.SetRevisedShipping(It.IsAny<int>()))
                .Verifiable();
            ...
            var response = await controller.SetRevisedShipping(It.IsAny<int>());
