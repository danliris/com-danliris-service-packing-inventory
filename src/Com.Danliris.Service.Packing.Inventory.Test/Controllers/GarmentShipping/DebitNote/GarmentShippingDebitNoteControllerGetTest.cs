...
{
    public class GarmentShippingDebitNoteControllerGetTest : GarmentShippingDebitNoteControllerTest
    {
        [Fact]
        public void Get_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<GarmentShippingDebitNoteViewModel>(new List<GarmentShippingDebitNoteViewModel>(), 1, 1, 1));
