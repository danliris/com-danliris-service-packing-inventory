...
{
    public class GarmentShippingDebitNoteControllerPostTest : GarmentShippingDebitNoteControllerTest
    {
        [Fact]
        public async Task Post_Created()
        {
            ...
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentShippingDebitNoteViewModel>()))
                .ReturnsAsync(1);
            var service = serviceMock.Object;

            var validateServiceMock = new Mock<IValidateService>();
            validateServiceMock
                .Setup(s => s.Validate(It.IsAny<GarmentShippingDebitNoteViewModel>()))
                .Verifiable();
