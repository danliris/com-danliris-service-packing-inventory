...
{
    public class GarmentShippingDebitNoteControllerTest
    {
        protected GarmentShippingDebitNoteController GetController(IGarmentShippingDebitNoteService service, IIdentityProvider identityProvider, IValidateService validateService)
        {
            ...
            var controller = new GarmentShippingDebitNoteController(service, identityProvider, validateService)
            {
        ...
        protected virtual GarmentShippingDebitNoteViewModel ViewModel
        {
            get
            {
