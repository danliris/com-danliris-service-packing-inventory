...
{
    public class GarmentShippingExportSalesDOControllerGetByIdTest : GarmentShippingExportSalesDOControllerTest
    {
        [Fact]
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingExportSalesDOViewModel());
