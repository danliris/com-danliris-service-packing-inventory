...
{
    public class GarmentShippingExportSalesDOControllerPutTest : GarmentShippingExportSalesDOControllerTest
    {
        [Fact]
        public async Task Put_Ok()
        {
            ...
            serviceMock
                .Setup(s => s.Update(It.IsAny<int>(), It.IsAny<GarmentShippingExportSalesDOViewModel>()))
                .ReturnsAsync(1);
