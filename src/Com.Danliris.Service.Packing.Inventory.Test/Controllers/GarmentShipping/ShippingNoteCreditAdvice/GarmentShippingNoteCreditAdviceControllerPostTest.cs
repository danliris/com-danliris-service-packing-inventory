...
{
    public class GarmentShippingNoteCreditAdviceControllerPostTest : GarmentShippingNoteCreditAdviceControllerTest
    {
        [Fact]
        public async Task Post_Created()
        {
            ...
            serviceMock
                .Setup(s => s.Create(It.IsAny<GarmentShippingNoteCreditAdviceViewModel>()))
                .ReturnsAsync(1);
