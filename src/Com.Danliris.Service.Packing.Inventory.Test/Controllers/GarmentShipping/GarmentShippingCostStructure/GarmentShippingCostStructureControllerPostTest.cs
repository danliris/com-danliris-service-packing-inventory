...
{
    public class GarmentShippingCostStructureControllerPostTest : GarmentShippingCostStructureControllerTest
    {
		[Fact]
		public async Task Post_Created()
		{
			...
			serviceMock
				.Setup(s => s.Create(It.IsAny<GarmentShippingCostStructureViewModel>()))
				.ReturnsAsync(1);
