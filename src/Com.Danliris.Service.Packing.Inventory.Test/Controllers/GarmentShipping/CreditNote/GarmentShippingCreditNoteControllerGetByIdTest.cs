...
{
    public class GarmentShippingCreditNoteControllerGetByIdTest : GarmentShippingCreditNoteControllerTest
    {
        [Fact]
        public async Task GetById_Ok()
        {
            ...
            serviceMock
                ...
                .ReturnsAsync(new GarmentShippingCreditNoteViewModel());
