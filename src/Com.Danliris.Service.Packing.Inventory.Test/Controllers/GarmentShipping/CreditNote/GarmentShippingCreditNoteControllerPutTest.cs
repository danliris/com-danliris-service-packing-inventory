...
{
    public class GarmentShippingCreditNoteControllerPutTest : GarmentShippingCreditNoteControllerTest
    {
        [Fact]
        public async Task Put_Ok()
        {
            ...
            serviceMock
                .Setup(s => s.Update(It.IsAny<int>(), It.IsAny<GarmentShippingCreditNoteViewModel>()))
                .ReturnsAsync(1);
