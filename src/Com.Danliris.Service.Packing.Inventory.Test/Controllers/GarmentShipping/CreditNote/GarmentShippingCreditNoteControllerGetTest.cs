...
{
    public class GarmentShippingCreditNoteControllerGetTest : GarmentShippingCreditNoteControllerTest
    {
        [Fact]
        public void Get_Ok()
        {
            ...
            serviceMock
                ...
                .Returns(new ListResult<GarmentShippingCreditNoteViewModel>(new List<GarmentShippingCreditNoteViewModel>(), 1, 1, 1));
