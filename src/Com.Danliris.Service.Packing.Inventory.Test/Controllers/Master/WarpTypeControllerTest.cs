...
{
    public class WarpTypeControllerTest
    {
        private WarpTypeController GetController(IWarpTypeService service, IIdentityProvider identityProvider, IValidateService validateService)
        {
            ...
            var controller = new WarpTypeController(service, identityProvider, validateService)
            {
        ...
        public async Task Should_Success_Post()
        {
            ...
            //v
            var serviceMock = new Mock<IWarpTypeService>();
            serviceMock.Setup(s => s.Create(It.IsAny<WarpTypeViewModel>())).ReturnsAsync(1);
            ...
            validateServiceMock.Setup(s => s.Validate(It.IsAny<WarpTypeViewModel>()))
                .Verifiable();
        ...
        {
            var dataUtil = new WarpTypeViewModel();
            //v
            var serviceMock = new Mock<IWarpTypeService>();
            serviceMock.Setup(s => s.Create(It.IsAny<WarpTypeViewModel>())).ReturnsAsync(1);
            var service = serviceMock.Object;
        ...
        public async Task Should_Exception_Post()
        {
            ...
            //v
            var serviceMock = new Mock<IWarpTypeService>();
            serviceMock.Setup(s => s.Create(It.IsAny<WarpTypeViewModel>())).ThrowsAsync(new Exception());
            var service = serviceMock.Object;
        ...
        public void Should_Success_Get()
        {
            ...
            serviceMock.Setup(s => s.Read(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .Returns(new ListResult<WarpTypeViewModel>(new List<WarpTypeViewModel>() { ViewModel }, 1, 1, 1));
            var service = serviceMock.Object;
        ...
        public async Task Should_Success_Put()
        {
            ...
            //v
            var serviceMock = new Mock<IWarpTypeService>();
            serviceMock.Setup(s => s.Update(It.IsAny<int>(), It.IsAny<WarpTypeViewModel>())).ReturnsAsync(1);
            var service = serviceMock.Object;
        ...
        public async Task Should_Exception_Put()
        {
            ...
            //v
            var serviceMock = new Mock<IWarpTypeService>();
            serviceMock.Setup(s => s.Update(It.IsAny<int>(), It.IsAny<WarpTypeViewModel>())).Throws(new Exception("mess"));
            var service = serviceMock.Object;
        ...
        {
            var dataUtil = ViewModel;
            var header = new List<string>() { "Jenis Lusi", "Kode" };
        ...
        {
            var dataUtil = ViewModel;
            var header = "Jenis Lusi, Kode";
            var isi = $"{ViewModel.Type}, {ViewModel.Code}";
            //v
            var serviceMock = new Mock<IWarpTypeService>();
            serviceMock.Setup(s => s.ValidateHeader(It.IsAny<IEnumerable<string>>()))
                .Returns(true);
            serviceMock.Setup(s => s.UploadValidate(It.IsAny<IEnumerable<WarpTypeViewModel>>()))
        ...
        public async Task Should_Return_Created_Upload()
        {
            ...
            serviceMock.Setup(s => s.Upload(It.IsAny<IEnumerable<WarpTypeViewModel>>()))
               .ReturnsAsync(1);
            var service = serviceMock.Object;
