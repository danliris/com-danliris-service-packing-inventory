  ...
  public class InventoryDocumentPackingControllerTest
    {
        ...
        private InventoryDocumentPackingController GetController(IInventoryDocumentPackingService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new InventoryDocumentPackingController(service, identityProvider)
            {
