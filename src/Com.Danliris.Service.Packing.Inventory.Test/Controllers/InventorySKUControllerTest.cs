...
namespace Com.Danliris.Service.Packing.Inventory.Test.Controllers
{
  public  class InventorySKUControllerTest
    {
        private InventorySKUController GetController(IInventoryDocumentPackingService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new InventorySKUController(service, identityProvider)
            {
