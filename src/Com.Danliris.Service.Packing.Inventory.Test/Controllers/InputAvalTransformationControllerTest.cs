...
{
    public class InputAvalTransformationControllerTest
    {
        private InputAvalTransformationController GetController(IInputAvalTransformationService service, IIdentityProvider identityProvider, IValidateService validateService)
        {
            ...
            var controller = new InputAvalTransformationController(service, identityProvider, validateService)
            {
        ...
        public async Task Should_Success_Post()
        {
            ...
            //v
            var serviceMock = new Mock<IInputAvalTransformationService>();
            serviceMock.Setup(s => s.Create(It.IsAny<InputAvalTransformationViewModel>())).ReturnsAsync(1);
            ...
            validateServiceMock.Setup(s => s.Validate(It.IsAny<InputAvalTransformationViewModel>()))
                .Verifiable();
        ...
        {
            var dataUtil = new InputAvalTransformationViewModel();
            //v
            var serviceMock = new Mock<IInputAvalTransformationService>();
            serviceMock.Setup(s => s.Create(It.IsAny<InputAvalTransformationViewModel>())).ReturnsAsync(1);
            var service = serviceMock.Object;
        ...
        public async Task Should_Exception_Post()
        {
            ...
            //v
            var serviceMock = new Mock<IInputAvalTransformationService>();
            serviceMock.Setup(s => s.Create(It.IsAny<InputAvalTransformationViewModel>())).ThrowsAsync(new Exception());
            var service = serviceMock.Object;
        ...
        public void Should_Success_Get()
        {
            ...
            serviceMock.Setup(s => s.Read(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .Returns(new ListResult<InputAvalTransformationViewModel>(new List<InputAvalTransformationViewModel>(), 1, 1, 1));
            var service = serviceMock.Object;
        ...
        [Fact]
        public void Should_Success_GetAvalInput()
        {
            //v
            var serviceMock = new Mock<IInputAvalTransformationService>();
            serviceMock.Setup(s => s.GetInputAvalProductionOrders(It.IsAny<string>()))
                .Returns(ViewModel.AvalTransformationProductionOrders.ToList());
            var service = serviceMock.Object;
            ...
            var controller = GetController(service, identityProvider, validateService);
            //controller.ModelState.IsValid == false;
            var response = controller.GetInputAval("type");

            Assert.Equal((int)HttpStatusCode.OK, GetStatusCode(response));
        }

        [Fact]
        public void Should_Exception_GetAvalInput()
        {
            //v
            var serviceMock = new Mock<IInputAvalTransformationService>();
            serviceMock.Setup(s => s.GetInputAvalProductionOrders(It.IsAny<string>()))
        ...
        public async Task Should_Success_Put()
        {
            ...
            //v
            var serviceMock = new Mock<IInputAvalTransformationService>();
            serviceMock.Setup(s => s.Update(It.IsAny<int>(), It.IsAny<InputAvalTransformationViewModel>())).ReturnsAsync(1);
            var service = serviceMock.Object;
        ...
        public async Task Should_Exception_Put()
        {
            ...
            //v
            var serviceMock = new Mock<IInputAvalTransformationService>();
            serviceMock.Setup(s => s.Update(It.IsAny<int>(), It.IsAny<InputAvalTransformationViewModel>())).Throws(new Exception("mess"));
            var service = serviceMock.Object;
