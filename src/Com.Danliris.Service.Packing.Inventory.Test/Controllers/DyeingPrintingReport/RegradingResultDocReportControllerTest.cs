...
{
    public class RegradingResultDocReportControllerTest
    {
        protected RegradingResultDocReportController GetController(IRegradingResultDocReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new RegradingResultDocReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IRegradingResultDocReportService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<RegradingResultDocReportViewModel>());
