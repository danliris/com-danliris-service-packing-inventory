...
{
    public class FabricQualityControlReportControllerTest
    {
        protected FabricQualityControlReportController GetController(IFabricQualityControlReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new FabricQualityControlReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IFabricQualityControlReportService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<FabricQualityControlReportViewModel>());
            ...
            var response = controller.GetReport(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>());
        ...
        public void GetGenerateExcel_Error()
        {
            ...
            var controller = GetController(service, identityProvider);
            controller.ControllerContext.HttpContext.Request.Headers["Accept"] = "application/xls";
            var response = controller.GetXls(null, It.IsAny<DateTime>(), It.IsAny<DateTime>());
