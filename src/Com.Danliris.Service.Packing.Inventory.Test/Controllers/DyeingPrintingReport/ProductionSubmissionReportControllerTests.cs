...
{
    public class ProductionSubmissionReportControllerTests
    {
        protected ProductionSubmissionReportController GetController(IProductionSubmissionReportService service, IIdentityProvider identityProvider)
        {
            ...
            var controller = new ProductionSubmissionReportController(service, identityProvider)
            {
        ...
        {
            var serviceMock = new Mock<IProductionSubmissionReportService>();
            serviceMock
                .Setup(s => s.GetReportData(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>()))
                .Returns(new List<ProductionSubmissionReportViewModel>());
            ...
            var response = controller.GetReport(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<DateTime>());
        ...
        public void GetGenerateExcel_Error()
        {
            ...
            var controller = GetController(service, identityProvider);
            controller.ControllerContext.HttpContext.Request.Headers["Accept"] = "application/xls";
            var response = controller.GetXls(null,null, It.IsAny<DateTime>(), It.IsAny<DateTime>());
