...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.LocalReturnNote
{
    public class GarmentShippingLocalReturnNoteServiceTest
    {
        ...
        {
            var model = new GarmentShippingLocalReturnNoteModel("", 1, DateTimeOffset.Now, "", new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "", "", 1, "", "", "", "", 1, "", "", true, 1, 1, "", true, false, false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", null), new List<GarmentShippingLocalReturnNoteItemModel>());
