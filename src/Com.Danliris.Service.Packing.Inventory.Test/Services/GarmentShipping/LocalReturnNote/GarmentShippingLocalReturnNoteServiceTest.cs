...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.LocalReturnNote
{
    public class GarmentShippingLocalReturnNoteServiceTest
    {
        ...
        {
            var model = new GarmentShippingLocalReturnNoteModel("", 1, DateTimeOffset.Now, "", new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "", "", 1, "", "", "", "", 1, "", "", true, "", true, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, null), new List<GarmentShippingLocalReturnNoteItemModel>());
        ...
        public async Task ReadById_Success()
        {
            ...
            var model = new GarmentShippingLocalReturnNoteModel("", 1, DateTimeOffset.Now, "", new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "", "", 1, "", "", "", "", 1, "", "", true, "", true, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, null), items);
