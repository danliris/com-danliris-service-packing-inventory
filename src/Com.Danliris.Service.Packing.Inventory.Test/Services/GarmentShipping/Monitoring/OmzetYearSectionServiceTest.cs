    ...
    public class OmzetYearSectionServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var invoiceItemModels = new HashSet<GarmentShippingInvoiceItemModel> {
                new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 1, "Sectionbrandname", 1, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc", "comodesc", "comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "Sectioncode", 3, 1)
                {
                    Id = 1
                },
            ...
            var invoiceModel = new GarmentShippingInvoiceModel(1, "plType", "invoiceno", DateTimeOffset.Now, "from", "to", 1, "Sectioncode", "Sectionname", "consignee", "lcno", "issuedby", 1, "sectioncode", "shippingper", DateTimeOffset.Now, "confNo", 1, "staff", 1, "cottn", 1, "mandiri", 10, "", DateTimeOffset.Now, "", DateTimeOffset.Now, "", "", invoiceItemModels, 1000, 1000, "23", "dsdsds", "memo", false, "", DateTimeOffset.Now, "", DateTimeOffset.Now, "", DateTimeOffset.Now, null, 100000, "aa", "aa", invoiceUnitModels, 1, 1)
            {
                Id = 1,
