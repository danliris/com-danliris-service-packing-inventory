...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.Monitoring
{
    public class GarmentOmetMonthlyByComodityServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var model2 = new GarmentPackingListModel("", "", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "Australia", DateTimeOffset.Now, DateTimeOffset.Now, true, true, null, 1, 1, 1, null, "", "", "", "", true, true, GarmentPackingListStatusEnum.ON_PROCESS)
            {
                Id = 1
            };
