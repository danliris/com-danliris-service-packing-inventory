...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.Monitoring
{
    public class GarmentOmetMonthlyByComodityServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var model1 = new GarmentShippingInvoiceItemModel("", "", 1, "", 1, 1, "MS", "TES COMODITY 1", "", "", "", "", 1, "", 1, 1, 1, "", 1, "C10", 1, 1)
            {
                GarmentShippingInvoiceId = 1
            };

            var model2 = new GarmentPackingListModel("", "", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "", "Australia", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, true, true, "", "", "", null, 1, 1, 1, 1, null, "", "", "", "", "", "", "", true, true, 1, "", GarmentPackingListStatusEnum.CREATED, "", false, "", false, false, false)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success()
        {
            var items = new List<GarmentShippingInvoiceItemModel>
                {
                     ...
                     new GarmentShippingInvoiceItemModel("", "", 1, "", 1, 1, "GB", "TES COMODITY 3", "", "", "", "", 2, "Uom2", 1, 1, 1, "", 1, "B10", 1, 3)
                         {
                           GarmentShippingInvoiceId = 1
                         },
                };
            ...
            var model2 = new GarmentPackingListModel("", "", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "", "Australia", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, true, true, "", "", "", null, 1, 1, 1, 1, null, "", "", "", "", "", "", "", true, true, 1, "", GarmentPackingListStatusEnum.CREATED, "", true, "", true, true, true)
            {
                Id = 1
            };
