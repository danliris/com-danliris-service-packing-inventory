...
{
    public class OmzetYearMarketingServiceServiceTest
    {
        ...
        protected OmzetYearMarketingService GetService(IServiceProvider serviceProvider)
        {
            return new OmzetYearMarketingService(serviceProvider);
        }
        ...
        public void GetReportData_Success()
        {
            ...
            var invoiceItemModels = new List<GarmentShippingInvoiceItemModel>
                {
                new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 1, "buyerbrandname", 10, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc", "comodesc", "comodesc", 1, "PCS", 10, 10, 100, "usd", 1, "unitcode", 3, 1)
                {
                    GarmentShippingInvoiceId = 1
                },
                new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 1, "buyerbrandname", 15, 2, "comocode2", "comoname2", "comodesc2", "marketing", "comodesc", "comodesc", "comodesc", 2, "SETS", 20, 20, 300, "usd", 1, "unitcode", 3, 2)
                {
                    GarmentShippingInvoiceId = 1
                },
                new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 2, "buyerbrandname2", 10, 1, "comocode", "comoname", "comodesc", "marketing1", "comodesc", "comodesc", "comodesc", 1, "PCS", 10, 10, 100, "usd", 1, "unitcode", 3, 3)
                {
                    GarmentShippingInvoiceId = 1
                },
                new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 2, "buyerbrandname2", 15, 2, "comocode2", "comoname2", "comodesc2", "marketing1", "comodesc", "comodesc", "comodesc", 2, "SETS", 20, 20, 300, "usd", 1, "unitcode", 0, 4)
                {
                    GarmentShippingInvoiceId = 1
                }
