...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.Monitoring
{
    public class GarmentLocalSalesBookServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "", "LBL TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1,"", false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success_LBL()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "LBL", "LBL TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success_LBJ()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "LBJ", "LBJ TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success_LBM()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "LBM", "LBM TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success_LJS()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "LJS", "LJS TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success_SBJ()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "SBJ", "SBJ TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success_SMR()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "SMR", "SMR TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
