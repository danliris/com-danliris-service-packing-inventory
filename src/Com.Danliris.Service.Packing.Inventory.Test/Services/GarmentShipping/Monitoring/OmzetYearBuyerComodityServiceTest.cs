...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.Monitoring
{
    public class OmzetYearBuyerComodityServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var packinglistmodel = new GarmentPackingListModel("", "", "DL", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "USA", DateTimeOffset.Now, DateTimeOffset.Now, true, true, null, 1, 1, 1, null, "", "", "", "", true)
            {
                Id = 1
            };
            ...
            var invoiceItemModels = new List<GarmentShippingInvoiceItemModel>
                ...
                new GarmentShippingInvoiceItemModel("ro", "scno", 1, "buyerbrandname", 15, 2, "comocode2", "comoname2", "comodesc2", 2, "SETS", 20, 20, 300, "usd", 1, "unitcode", 3)
                {
                    GarmentShippingInvoiceId = 1
                },
                new GarmentShippingInvoiceItemModel("ro", "scno", 2, "buyerbrandname2", 10, 1, "comocode", "comoname", "comodesc", 1, "PCS", 10, 10, 100, "usd", 1, "unitcode", 3)
                {
                    GarmentShippingInvoiceId = 1
                },
                new GarmentShippingInvoiceItemModel("ro", "scno", 2, "buyerbrandname2", 15, 2, "comocode2", "comoname2", "comodesc2", 2, "SETS", 20, 20, 300, "usd", 1, "unitcode", 3)
                {
                    GarmentShippingInvoiceId = 1
                }
