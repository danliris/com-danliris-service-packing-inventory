    ...
    public class OmzetYearBuyerComodityServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var invoiceItemModels = new List<GarmentShippingInvoiceItemModel>
                ...
                new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 2, "buyerbrandname2", 10, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc", "comodesc", "comodesc", 1, "PCS", 10, 10, 100, "usd", 1, "unitcode", 3, 3)
                {
                    GarmentShippingInvoiceId = 1
                },
