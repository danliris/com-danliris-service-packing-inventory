...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.Monitoring
{
    public class GarmentOmetMonthlyBySectionServiceTest
    {
        ...
        public void GetReportData_Success()
        {
            ...
            var model2 = new GarmentPackingListModel("", "", "DL", 1, "A", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "", DateTimeOffset.Now, DateTimeOffset.Now, true, true, null, 1, 1, 1, null, "", "", "", "", true)
            {
                Id = 1
            };
