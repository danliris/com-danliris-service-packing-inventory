...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.Monitoring
{
    public class GarmentPackingListMonitoringServiceTest
    {
        ...
        {
            var model = new GarmentPackingListModel("", "", "SL", 1, "", DateTimeOffset.Now, "", "", 1, "", "", "", DateTimeOffset.Now, DateTimeOffset.Now, false, false, null, 1, 1, 1, null, "", "", "", false)
            {
                Id = 1
            };
        ...
        public void GenerateExcel_Success()
        {
            ...
            var result = service.GenerateExcel(model.Id, model.InvoiceType, DateTimeOffset.MinValue, DateTimeOffset.MaxValue);
        ...
        public void GenerateExcel_Empty_Success()
        {
            ...
            var result = service.GenerateExcel(0, null, null, null);
