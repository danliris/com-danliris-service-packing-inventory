...
{
    public class GarmentLocalSalesOmzetUnPaidServiceTest
    {
        ...
        protected GarmentLocalSalesOmzetUnPaidService GetService(IServiceProvider serviceProvider)
        {
            return new GarmentLocalSalesOmzetUnPaidService(serviceProvider);
        }

        [Fact]
        public void GetReportData_SML_Success()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "SML", "SML TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
            ...
            var modelDetail = new GarmentShippingDetailLocalSalesNoteModel("SC1", 1, 1, "LSN1", DateTimeOffset.Now, 1, "SML", "SML TRANSAKSI", 1, "A999", "BUYER A", 600, itemDetails)
            {
                LocalSalesNoteId = 1
            };
            //
        ...
        public void GetReportData_LMS_Success()
        {
            ...
            var model = new GarmentShippingLocalSalesNoteModel("", 1, "", "", DateTimeOffset.Now, 1, "LMS", "LMS TRANSAKSI", 1, "A999", "", "", "", 1, "", "", true, 1, 1, "", false, false, false, false, false, null, null, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", 1, "", "", items)
            {
                Id = 1
            };
            ...
            var modelDetail = new GarmentShippingDetailLocalSalesNoteModel("SC1", 1, 1, "LSN1", DateTimeOffset.Now, 1, "LMS", "LMS TRANSAKSI", 1, "A999", "BUYER A", 600, itemDetails)
            {
                LocalSalesNoteId = 1
            };
            //
        ...
        [Fact]
        public void GenerateExcel_SML_Success()
        {
            var items = new List<GarmentShippingLocalSalesNoteItemModel>
                {
                     new GarmentShippingLocalSalesNoteItemModel(1,1, "", "", 1, 1, "UOM1", 1, 1, 1, "", "")
        ...
        [Fact]
        public void GenerateExcel_LMS_Success()
        {
            var items = new List<GarmentShippingLocalSalesNoteItemModel>
                {
                     new GarmentShippingLocalSalesNoteItemModel(1,1, "", "", 1, 1, "UOM1", 1, 1, 1, "", "")
        ...
        //
        [Fact]
        public void GenerateExcel_Detail_SML_Success()
        {
            var items = new List<GarmentShippingLocalSalesNoteItemModel>
                {
                     new GarmentShippingLocalSalesNoteItemModel(1,1, "", "", 1, 1, "UOM1", 1, 1, 1, "", "")
        ...
        [Fact]
        public void GenerateExcel_Detail_LMS_Success()
        {
            var items = new List<GarmentShippingLocalSalesNoteItemModel>
                {
                     new GarmentShippingLocalSalesNoteItemModel(1,1, "", "", 1, 1, "UOM1", 1, 1, 1, "", "")
