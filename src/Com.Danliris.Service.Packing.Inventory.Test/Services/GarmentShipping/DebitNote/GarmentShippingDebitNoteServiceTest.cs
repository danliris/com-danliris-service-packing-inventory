...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.GarmentShippingDebitNote
{
    public class GarmentShippingDebitNoteServiceTest
    {
        ...
        {
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.ND, "", DateTimeOffset.Now, 1, "", "", 1, "", "", 1, new List<GarmentShippingNoteItemModel>());
        ...
        public async Task ReadById_Success()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.ND, "", DateTimeOffset.Now, 1, "", "", 1, "", "", 1, items);
