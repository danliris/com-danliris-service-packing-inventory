...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.PaymentDispositionRecap
{
    public class PaymentDispositionRecapServiceTest
    {
        ...
        public async Task ReadById_Success()
        {
            ...
            var details = new HashSet<GarmentShippingPaymentDispositionRecapDetailModel> { new GarmentShippingPaymentDispositionRecapDetailModel(1, 1, 10) { Id = 1 } };
            var item = new GarmentShippingPaymentDispositionRecapItemModel(1, details) { Id = 1 };
