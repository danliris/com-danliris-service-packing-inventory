...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.PaymentDispositionRecap
{
    public class PaymentDispositionRecapServiceTest
    {
        ...
        public async Task ReadById_Success()
        {
            ...
            var itemsInvoice = new HashSet<GarmentShippingInvoiceItemModel> { new GarmentShippingInvoiceItemModel("ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc", "comodesc", "comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 1) { Id = 1 } };
