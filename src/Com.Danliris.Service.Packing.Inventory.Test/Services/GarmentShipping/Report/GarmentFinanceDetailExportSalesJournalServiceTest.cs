...
{
    public class GarmentFinanceDetailExportSalesJournalServiceTest
    {
        ...
        protected GarmentFinanceDetailExportSalesJournalService GetService(IServiceProvider serviceProvider)
        {
            return new GarmentFinanceDetailExportSalesJournalService(serviceProvider);
        }
        ...
        public void GetReportData_Success()
        {
            ...
            var result = service.GetReportQuery(model1.TruckingDate.Date, model1.TruckingDate.Date, 7);
