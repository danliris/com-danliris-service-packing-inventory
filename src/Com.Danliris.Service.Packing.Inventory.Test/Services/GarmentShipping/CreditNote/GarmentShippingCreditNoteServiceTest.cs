...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.GarmentShippingCreditNote
{
    public class GarmentShippingCreditNoteServiceTest
    {
        ...
        {
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 0, null, null, null, 1, new List<GarmentShippingNoteItemModel>());
        ...
        public async Task ReadById_Success()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 0, null, null, null, 1, items);
