...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services.GarmentShipping.GarmentShippingCreditNote
{
    public class GarmentShippingCreditNoteServiceTest
    {
        ...
        {
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 0, null, null, null, 1, 1, new List<GarmentShippingNoteItemModel>());
        ...
        public async Task ReadById_Success()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 0, null, null, null, 1, 1, items);
        ...
        public async Task ReadPdfById_Success_USD()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 1, "", "", "", 1, 1, items);
        ...
        public async Task ReadPdfById_Success_USD1()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 1, "", "", "", 1.50, 1, items);
        ...
        public async Task ReadPdfById_Success_USD2()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 1, "", "", "", 1.18, 1, items);
        ...
        public async Task ReadPdfById_Success_USD3()
        {
            ...
            var model = new GarmentShippingNoteModel(GarmentShippingNoteTypeEnum.CN, "", DateTimeOffset.Now, 1, "", "", "", "", DateTimeOffset.Now, 1, "", "","", 1.74, 1, items);
