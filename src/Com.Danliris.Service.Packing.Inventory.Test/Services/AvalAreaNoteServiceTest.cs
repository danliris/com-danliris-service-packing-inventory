...
{
    public class AvalAreaNoteServiceTest
    {
        public AvalAreaNoteService GetService(IServiceProvider serviceProvider)
        {
            return new AvalAreaNoteService(serviceProvider);
        }
        ...
        public void Should_Success_GetReport()
        {
            ...
            var result = service.GetReport(Model.Date.ToOffset(new TimeSpan(7, 0, 0)), Model.Shift, Model.Mutation, Model.Area, 7);
        ...
        public void Should_Success_GenerateExcel()
        {
            ...
            var result = service.GenerateExcel(Model.Date.ToOffset(new TimeSpan(7, 0, 0)), Model.Shift, Model.Mutation, Model.Area, 7);
        ...
        public void Should_Empty_GenerateExcel()
        {
            ...
            var result = service.GenerateExcel(Model.Date.ToOffset(new TimeSpan(7, 0, 0)).AddDays(3), Model.Shift, Model.Mutation, Model.Area, 7);
