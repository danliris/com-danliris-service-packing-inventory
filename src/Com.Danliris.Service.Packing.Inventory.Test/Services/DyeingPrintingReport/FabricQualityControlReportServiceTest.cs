...
{
    public class FabricQualityControlReportServiceTest
    {
        ...
        protected FabricQualityControlReportService GetService(IServiceProvider serviceProvider)
        {
            return new FabricQualityControlReportService(serviceProvider);
        }

        [Fact]
        public void GetReportData_Success()
        {
            var item = new DyeingPrintingAreaOutputProductionOrderModel("INSPECTION MATERIAL", "", false, 1, "no", "", 1, "", "", "", "", "", "", "", "", "", "",
            ...
            var model = new DyeingPrintingAreaOutputModel(DateTimeOffset.Now, "INSPECTION MATERIAL", "", "", false, "", "", 1, "", false, "", "", "", "",
                "", "", "", "", "", false, "", items) { Id = 1, CreatedUtc=DateTime.Now };
