...
{
    public class ShippingAreaNoteServiceTest
    {
        public ShippingAreaNoteService GetService(IServiceProvider serviceProvider)
        {
            return new ShippingAreaNoteService(serviceProvider);
        }
        ...
        public void Should_Success_GetReport()
        {
            ...
            var result = service.GetReport(Model.Date.ToOffset(new TimeSpan(7, 0, 0)), Model.Mutation, Model.Area, 7);
        ...
        //    var result = service.GenerateExcel(Model.Date.ToOffset(new TimeSpan(7, 0, 0)), Model.Mutation, Model.Area, 7);
        ...
        //    var result = service.GenerateExcel(Model.Date.ToOffset(new TimeSpan(7, 0, 0)).AddDays(3), Model.Mutation, Model.Area, 7);
