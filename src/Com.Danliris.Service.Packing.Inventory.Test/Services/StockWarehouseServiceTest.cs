...
namespace Com.Danliris.Service.Packing.Inventory.Test.Services
{
    public class StockWarehouseServiceTest
    {
        ...
        private DyeingPrintingAreaInputModel Model
        {
            get
            {
                return new DyeingPrintingAreaInputModel(ViewModel.Date, ViewModel.Area, ViewModel.Shift, ViewModel.BonNo, ViewModel.Group, ViewModel.PackagingProductionOrders.Select(s =>
                    ...
                    s.MaterialConstruction.Name, s.MaterialWidth, 0, "", s.PackingType, 0, "", "", s.ProcessType.Id, s.ProcessType.Name, s.YarnMaterial.Id, s.YarnMaterial.Name)).ToList());
            }
        }
        private DyeingPrintingAreaOutputModel OutputModel
        {
            get
            {
                return new DyeingPrintingAreaOutputModel(ViewModel.Date, ViewModel.Area, ViewModel.Shift, ViewModel.BonNo, false, "PACKING", ViewModel.Group, "OUT", ViewModel.PackagingProductionOrders.Select(s =>
                    ...
                    s.MaterialWidth, "", 0, "", s.PackingType, 0, "", "", s.ProcessType.Id, s.ProcessType.Name, s.YarnMaterial.Id, s.YarnMaterial.Name)).ToList());
            }
        }
        ...
        private DyeingPrintingAreaMovementModel ModelOut
        {
            get
            {
                return new DyeingPrintingAreaMovementModel(DateTimeOffset.UtcNow, "PACKING", "OUT", 1, "no", 1, "no", "car", "uu", "cos", "unit", "coo", "motif",
                     "unit", ViewModel1.Keluar, 1, "type", "gr", "rem", "type");
            }
        }
        ...
        private DyeingPrintingAreaMovementModel ModelIn
        {
            get
            {
                return new DyeingPrintingAreaMovementModel(DateTimeOffset.UtcNow, "PACKING", "IN", 1, "no", 1, "no", "car", "uu", "cos", "unit", "coo", "motif",
                     "unit", ViewModel1.Masuk, 1, "type", "gr", "rem", "type");
            }
        }
        ...
        public void Should_Success_Read()
        {
            ...
            sppRepoMock.Setup(s => s.ReadAll())
                .Returns(new List<DyeingPrintingAreaInputProductionOrderModel> {
                    new DyeingPrintingAreaInputProductionOrderModel("PACKING", 1, "sd", "sd", "a", "a", "a", "a", "a", "a", "a", "a", 10, true, 10, "A",1,1,1,"s",1,"s",1,"s","1",1,"a",1,"a")
                }.AsQueryable());
            ...
            var result = service.GetReportData(ModelIn.Date.AddDays(-1), ModelIn.Date.AddDays(3), "PACKING", 7, ModelIn.Unit, ModelIn.PackingType, ModelIn.Construction, ModelIn.Buyer, ModelIn.ProductionOrderId);
        ...
        public void Should_Success_GenerateExcel()
        {
            ...
            var testmodel = new DyeingPrintingAreaInputProductionOrderModel("PACKING", 1, "sd", "sd", "a", "a", "a", "a", "a", "a", "a", "a", 10, true, 10, "A", int.Parse("1"), 1, 1, "a", 1, "a", 1, "a", "1", 1, "a", 1, "a");
            testmodel.Id = 1;
            sppRepoMock.Setup(s => s.ReadAll())
                .Returns(
            ...
            var result = service.GenerateExcel(ModelIn.Date.AddDays(-1), ModelIn.Date.AddDays(3), "PACKING", 7, ModelIn.Unit, ModelIn.PackingType, ModelIn.Construction, ModelIn.Buyer, ModelIn.ProductionOrderId);
        ...
        public void Should_Empty_GenerateExcel()
        {
            ...
            var result = service.GenerateExcel(ModelIn.Date.AddDays(4), ModelIn.Date.AddDays(4), "TRANSIT", 7, ModelIn.Unit, ModelIn.PackingType, ModelIn.Construction, ModelIn.Buyer, ModelIn.ProductionOrderId);
