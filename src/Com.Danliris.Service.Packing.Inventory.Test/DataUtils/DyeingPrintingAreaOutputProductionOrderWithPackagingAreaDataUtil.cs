...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaOutputProductionOrderWithPackagingAreaDataUtil : BaseDataUtil<DyeingPrintingAreaOutputProductionOrderRepository, DyeingPrintingAreaOutputProductionOrderModel>
    {
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel("IM", "PACKING", false, 1, "a", "a", 1, "a", "a", "a", "c", "u", "c", "m", "a", "r", "g,", "s", 1, 1, 1, 1, "a", 1, "a", "1", "a", "a", 1, "a", 1, "a", 1, "a", 1, 1, "a", false, 1, 1, "a", false, 1, "a", DateTimeOffset.Now, DateTimeOffset.Now, "a");
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel(null, null, true, 0, null, null, 0, null, null, null, null, null, null, null, null, null, null, null, 0, 0, 0, 0, null, 0, null, "0", null, null, 0, null, 0, null, 0, null, 0, 0, null, true, 0, 0, null, true, 0, null, DateTimeOffset.Now, DateTimeOffset.Now, null);
            model.DyeingPrintingAreaOutput = new DyeingPrintingAreaOutputModel();
