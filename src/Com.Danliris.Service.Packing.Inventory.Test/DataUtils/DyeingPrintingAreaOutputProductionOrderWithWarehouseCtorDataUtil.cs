...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaOutputProductionOrderWithWarehouseCtorDataUtil : BaseDataUtil<DyeingPrintingAreaOutputProductionOrderRepository, DyeingPrintingAreaOutputProductionOrderModel>
    {
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel(11, "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", 2, "a", "a", 3, "a", 2, "s", 2, "a", true, "s", "d", 10, 1, 1, "a", 1, "a", "1", "a");
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel(0, null, null, null, null, null, null, null, null, null, null, null, 0, null, null, 0, null, 0, null, 0, null, true, null, null, 0, 0, 0, null, 0, null, "0", null);
            model.DyeingPrintingAreaOutput = new DyeingPrintingAreaOutputModel();
