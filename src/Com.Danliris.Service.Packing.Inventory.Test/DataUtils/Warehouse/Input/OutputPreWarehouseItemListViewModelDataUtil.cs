...
{
    public class OutputPreWarehouseItemListViewModelDataUtil
    {
        private OutputPreWarehouseItemListViewModel ProductionOrderItemListViewModel
        {
            get
            {
                return new OutputPreWarehouseItemListViewModel()
                {
                    Id = 3,
        ...
        {
            var dataUtil = ProductionOrderItemListViewModel;
