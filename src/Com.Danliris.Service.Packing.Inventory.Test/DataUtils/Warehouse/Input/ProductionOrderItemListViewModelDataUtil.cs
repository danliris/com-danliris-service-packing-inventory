...
{
    public class ProductionOrderItemListViewModelDataUtil
    {
        private ProductionOrderItemListViewModel ProductionOrderItemListViewModel
        {
            get
            {
                return new ProductionOrderItemListViewModel()
                {
                    Id = 3,
