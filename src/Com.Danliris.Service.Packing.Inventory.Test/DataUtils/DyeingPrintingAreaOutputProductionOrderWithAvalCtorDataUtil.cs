...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaOutputProductionOrderWithAvalCtorDataUtil : BaseDataUtil<DyeingPrintingAreaOutputProductionOrderRepository, DyeingPrintingAreaOutputProductionOrderModel>
    {
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel("IM", "AVAL", false, 1, "test", 1, "43124", "asdf", 1, "asdf", "asdfsad", "asf", "asdf", "asdf", "asdfa", "asfas", "note", 1, 1, "unit", "type", 1, 1);
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel(null, null, true, 0, null, 0, null, null, 0, null, null, null, null, null, null, null, null, 0, 1, null, null, 0, 0);
            model.DyeingPrintingAreaOutput = new DyeingPrintingAreaOutputModel();
