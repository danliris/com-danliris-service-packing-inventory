...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaInputProductionOrderWithRejectedWarehousesCtorDataUtil : BaseDataUtil<DyeingPrintingAreaInputProductionOrderRepository, DyeingPrintingAreaInputProductionOrderModel>
    {
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel(123, "asdf", "asdf", "asdf", "asdf", "asdf", "asdf", "asdf","asdf",123,true, "asdf", "asdf",123, "asdf", "asdf", "asdf",123,123,123, "asdf", "asdf",123,123, "asdf", "asdf", "asdf",123, "asdf",123,123);
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel(0, null, null, null, null, null, null, null, null, 0, false, null, null, 123, null, null, null, 123, 123, 123, null, null, 0, 0, null, null, null, 0, null, 0, 0);
            model.DyeingPrintingAreaInput = new DyeingPrintingAreaInputModel();
