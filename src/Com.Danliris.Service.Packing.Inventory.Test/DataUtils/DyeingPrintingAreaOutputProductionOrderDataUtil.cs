...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaOutputProductionOrderDataUtil : BaseDataUtil<DyeingPrintingAreaOutputProductionOrderRepository, DyeingPrintingAreaOutputProductionOrderModel>
    {
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel("IM", "AVAL", false, 1, "a", "e", 1, "rr", "1", "as", "test", "unit", "color", "motif", "mtr", "rem", "a", "a", 1, 1, 1, "type", 1, "name", 1, "a", "1", "qc1", "zimmer", "a", 1, "a", 1, "a", 1, 1, "a", false, "a",DateTimeOffset.Now);
        ...
        {
            var model = new DyeingPrintingAreaOutputProductionOrderModel(null, null, true, 0, null, null, 0, null, null, null, null, null, null, null, null, null, null, null, 0, 1, 0, null, 0, null, 0, null, "0", null, null, null, 0, null, 0, null, 0, 0, null, true, null,DateTimeOffset.Now);
