...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaInputProductionOrderWithOuputSPPIdDataUtil : BaseDataUtil<DyeingPrintingAreaInputProductionOrderRepository, DyeingPrintingAreaInputProductionOrderModel>
    {
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel("area", 1, "01", "SppOrderType", "packingInstruction", "cartNo", "buyer", "construction", "unit", "color", "motif", "uomUnit", 1, false, 1, "grade", 1, 1, 1, 1, "remark","zimmer", 1, "a", 1, "a", "1", 1, "a", 1, "a", 1, 1, "a", false, 1, 1, "a", false, 1);
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel(null, 1, null, null, null, null, null, null, null, null, null, null, 1, false, 1, null, 1, 1, 1, 1, null,null, 0, null, 0, null, "0", 0, null, 0, null, 0, 0, null, true, 0, 0, null, true, 0);
            model.DyeingPrintingAreaInput = new DyeingPrintingAreaInputModel();
