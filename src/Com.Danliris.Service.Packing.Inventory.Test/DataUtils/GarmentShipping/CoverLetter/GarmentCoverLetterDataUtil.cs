...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentCoverLetter
{
    public class GarmentCoverLetterDataUtil : BaseDataUtil<GarmentCoverLetterRepository, GarmentShippingCoverLetterModel>
    {
        ...
        {
            var model = new GarmentShippingCoverLetterModel(0, 0, null, DateTimeOffset.MinValue, 0, null, null, null, null, null, DateTimeOffset.MinValue, 0, null, null, 0, 0, 0, 0, 0, null, null, null, null, null, null, null, null, null, null, DateTimeOffset.MinValue, null, 0, null);
