...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentPackingList
{
    public class GarmentPackingListDataUtil : BaseDataUtil<GarmentPackingListRepository, GarmentPackingListModel>
    {
        ...
        public override GarmentPackingListModel GetModel()
        {
            ...
            var model = new GarmentPackingListModel("", "", "", 1, "", DateTimeOffset.Now, "", "", DateTimeOffset.Now, "", 1, "", "", "", "", DateTimeOffset.Now, DateTimeOffset.Now, DateTimeOffset.Now, false, false, "", "", "", items, 1, 1, 1, measurements, "", "", "", "", false, false, GarmentPackingListStatusEnum.CREATED);
        ...
        public override GarmentPackingListModel GetEmptyModel()
        {
            ...
            var model = new GarmentPackingListModel(null, null, null, 0, null, DateTimeOffset.MinValue, null, null, DateTimeOffset.MinValue, null, 0, null, null, null, null, DateTimeOffset.MinValue, DateTimeOffset.MinValue, DateTimeOffset.MinValue, false, false, "", "", "", items, 0, 0, 0, measurements, null, null, null, null, false, false, GarmentPackingListStatusEnum.CREATED);
        ...
        public GarmentPackingListModel CopyModel(GarmentPackingListModel om)
        {
            ...
            foreach (var i in om.Items)
            {
                ...
                foreach (var d in i.Details)
                {
                    ...
                    details.Add(new GarmentPackingListDetailModel(d.Carton1, d.Carton2, d.Colour, d.CartonQuantity, d.QuantityPCS, d.TotalQuantity, d.Length, d.Width, d.Height, d.CartonsQuantity, sizes) { Id = d.Id });
                }
            ...
            var model = new GarmentPackingListModel(om.InvoiceNo, om.PackingListType, om.InvoiceType, om.SectionId, om.SectionCode, om.Date, om.PaymentTerm, om.LCNo, om.LCDate, om.IssuedBy, om.BuyerAgentId, om.BuyerAgentCode, om.BuyerAgentName, om.Destination, om.ShipmentMode, om.TruckingDate, om.TruckingEstimationDate, om.ExportEstimationDate, om.Omzet, om.Accounting, om.FabricCountryOrigin, om.FabricComposition, om.RemarkMd, items, om.GrossWeight, om.NettWeight, om.TotalCartons, measurements, om.SayUnit, om.ShippingMark, om.SideMark, om.Remark, om.IsUsed, om.IsPosted, om.Status) { Id = om.Id };
