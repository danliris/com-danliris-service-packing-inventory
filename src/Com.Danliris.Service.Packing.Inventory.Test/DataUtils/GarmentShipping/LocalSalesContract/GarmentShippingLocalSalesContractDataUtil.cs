...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.LocalSalesContract
{
    public class GarmentShippingLocalSalesContractDataUtil : BaseDataUtil<GarmentShippingLocalSalesContractRepository, GarmentShippingLocalSalesContractModel>
    {
        ...
        {
            var items = new HashSet<GarmentShippingLocalSalesContractItemModel> { new GarmentShippingLocalSalesContractItemModel(1, "", "", 1, 1,1, "", 1, 1, "","","") };
        ...
        {
            var items = new HashSet<GarmentShippingLocalSalesContractItemModel> { new GarmentShippingLocalSalesContractItemModel(0, null, null, 0, 0,0, null, 0, 0, null, null,null) };
