...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentShippingInvoice
{
    public class GarmentShippingInvoiceDataUtil : BaseDataUtil<GarmentShippingInvoiceRepository, GarmentShippingInvoiceModel>
    {
        ...
        {
            var items = new HashSet<GarmentShippingInvoiceItemModel> { new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc", "comodesc", "comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 1) };
        ...
        public GarmentShippingInvoiceModel GetModels()
        {
            var items = new HashSet<GarmentShippingInvoiceItemModel> {
                new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc","comodesc","comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 1),new GarmentShippingInvoiceItemModel("expendituregoodno", "ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc","comodesc","comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 2) };
        ...
        {
            var items = new HashSet<GarmentShippingInvoiceItemModel> { new GarmentShippingInvoiceItemModel(null, null, null, 0, null, 0, 0, null, null, null, null, null, null, null, 0, null, 0, 0, 0, null, 0, null, 0, 0) };
            ...
            var model = new GarmentShippingInvoiceModel(0, null, null, DateTimeOffset.MinValue, null, null, 0, null, null, null, null, null, 0, null, null, DateTimeOffset.MinValue, null, 0, null, 0, null, 0, null, 0, "", DateTimeOffset.MinValue, "", DateTimeOffset.MinValue, "", "", items, 0, 0, "", "dsdsds", "memo", false, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, adjustments, 0, null, null, units, 0, 0);
        ...
        public GarmentShippingInvoiceModel CopyModel(GarmentShippingInvoiceModel om)
        {
            ...
            foreach (var i in om.Items)
            {
                ...
                items.Add(new GarmentShippingInvoiceItemModel(i.ExpenditureGoodNo, i.RONo, i.SCNo, i.BuyerBrandId, i.BuyerBrandName, i.Quantity, i.ComodityId, i.ComodityCode, i.ComodityName, i.ComodityDesc, i.MarketingName, i.Desc2, i.Desc3, i.Desc4, i.UomId, i.UomUnit, i.Price, i.PriceRO, i.Amount, i.CurrencyCode, i.UnitId, i.UnitCode, i.CMTPrice, i.PackingListItemId) { Id = i.Id });
            }
            ...
            var model = new GarmentShippingInvoiceModel(om.PackingListId, om.PLType, om.InvoiceNo, om.InvoiceDate, om.From, om.To, om.BuyerAgentId, om.BuyerAgentCode, om.BuyerAgentName, om.Consignee,
                ...
                om.CO, om.CODate, om.COTP, om.COTPDate, adjs, om.TotalAmount, om.ConsigneeAddress, om.DeliverTo, units, om.LessFabricCost, om.DHLCharges)
            { Id = om.Id };
