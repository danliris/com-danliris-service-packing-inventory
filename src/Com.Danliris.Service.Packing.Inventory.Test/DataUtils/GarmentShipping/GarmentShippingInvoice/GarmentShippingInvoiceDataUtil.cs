...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentShippingInvoice
{
	public class GarmentShippingInvoiceDataUtil : BaseDataUtil<GarmentShippingInvoiceRepository, GarmentShippingInvoiceModel>
	{
		...
		public override GarmentShippingInvoiceModel GetEmptyModel()
		{
			...
			var model = new GarmentShippingInvoiceModel(0, null, DateTimeOffset.MinValue, null, null, 0, null, null, null, null, null, 0, null, null, DateTimeOffset.MinValue, null, 0, null, 0, null, 0, null, 0, "", DateTimeOffset.MinValue, "", DateTimeOffset.MinValue, "", items, 0, "", "dsdsds", "memo", false, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, adjustments, 0);
