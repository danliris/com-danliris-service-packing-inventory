    ...
    public class GarmentShippingInvoiceDataUtil : BaseDataUtil<GarmentShippingInvoiceRepository, GarmentShippingInvoiceModel>
    {
        ...
        public GarmentShippingInvoiceModel GetModels()
        {
            var items = new HashSet<GarmentShippingInvoiceItemModel> {
                new GarmentShippingInvoiceItemModel("ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc","comodesc","comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 1),new GarmentShippingInvoiceItemModel("ro", "scno", 1, "buyerbrandname", 1, 1, "comocode", "comoname", "comodesc", "marketing", "comodesc","comodesc","comodesc", 1, "pcs", 10, 10, 100, "usd", 1, "unitcode", 3, 2) };
        ...
        {
            var items = new HashSet<GarmentShippingInvoiceItemModel> { new GarmentShippingInvoiceItemModel(null, null, 0, null, 0, 0, null, null, null, null, null, null, null, 0, null, 0, 0, 0, null, 0, null, 0, 0) };
            ...
            var model = new GarmentShippingInvoiceModel(0, null, DateTimeOffset.MinValue, null, null, 0, null, null, null, null, null, 0, null, null, DateTimeOffset.MinValue, null, 0, null, 0, null, 0, null, 0, "", DateTimeOffset.MinValue, "", DateTimeOffset.MinValue, "", "", items, 0, 0, "", "dsdsds", "memo", false, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, adjustments, 0, null, null, units, 0, 0);
