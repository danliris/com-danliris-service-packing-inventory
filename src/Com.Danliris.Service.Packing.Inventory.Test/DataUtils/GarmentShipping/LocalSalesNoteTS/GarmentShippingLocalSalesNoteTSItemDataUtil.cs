...
{
    public class GarmentShippingLocalSalesNoteTSItemDataUtil : BaseDataUtil<GarmentShippingLocalSalesNoteItemRepository, GarmentShippingLocalSalesNoteItemModel>
    {
        public GarmentShippingLocalSalesNoteTSItemDataUtil(GarmentShippingLocalSalesNoteItemRepository repository) : base(repository)
        {
        }
