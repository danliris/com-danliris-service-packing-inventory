...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentCreditAdvice
{
    public class GarmentCreditAdviceDataUtil : BaseDataUtil<GarmentShippingCreditAdviceRepository, GarmentShippingCreditAdviceModel>
    {
        ...
        {
            var model = new GarmentShippingCreditAdviceModel(0, 0, null, DateTimeOffset.MinValue, 0, 0, null, null, true, null, 0, 0, null, DateTimeOffset.MinValue, DateTimeOffset.MinValue, null, 0, 0, 0, DateTimeOffset.MinValue, 0, 0, 0, 0, 0, 0, 0, null, 0, null, null, 0, null, null, 0, 0, 0, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, 0, null, DateTimeOffset.MinValue, 0, DateTimeOffset.MinValue, null);
