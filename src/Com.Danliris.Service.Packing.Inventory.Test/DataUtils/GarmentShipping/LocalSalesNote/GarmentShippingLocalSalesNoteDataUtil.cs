...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentLocalSalesNote
{
    public class GarmentShippingLocalSalesNoteDataUtil : BaseDataUtil<GarmentShippingLocalSalesNoteRepository, GarmentShippingLocalSalesNoteModel>
    {
        ...
        {
            var items = new HashSet<GarmentShippingLocalSalesNoteItemModel> { new GarmentShippingLocalSalesNoteItemModel(1, "", "", 1, 1, "", 1, 1, 1, "") };
        ...
        {
            var items = new HashSet<GarmentShippingLocalSalesNoteItemModel> { new GarmentShippingLocalSalesNoteItemModel(0, null, null, 0, 0, null, 0, 0, 0, null) };
