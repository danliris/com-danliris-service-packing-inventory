...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentShippingCostStructure
{
    public class GarmentShippingCostStructureDataUtil : BaseDataUtil<GarmentShippingCostStructureRepository, GarmentShippingCostStructureModel>
    {
        ...
        {
            var model = new GarmentShippingCostStructureModel(null, DateTimeOffset.MinValue, 0, null, null, null, null, 0, null, 0);
        ...
        {
            var model = new GarmentShippingCostStructureModel(om.InvoiceNo, om.Date, om.ComodityId, om.ComodityCode, om.ComodityName, om.HsCode, om.Destination, om.FabricTypeId, om.FabricType, om.Amount){ Id = om.Id };
