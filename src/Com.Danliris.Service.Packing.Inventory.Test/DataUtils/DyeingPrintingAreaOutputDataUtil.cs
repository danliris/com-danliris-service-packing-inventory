...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaOutputDataUtil : BaseDataUtil<DyeingPrintingAreaOutputRepository, DyeingPrintingAreaOutputModel>
    {
        ...
        public override DyeingPrintingAreaOutputModel GetModel()
        {
            ...
            {
                new DyeingPrintingAreaOutputProductionOrderModel("TRANSIT","PACKING",false,1,"a","e",1,"rr","1","as","test","unit","color","motif","mtr", "rem","a","a",2, 1,1, 1, "name", 1, "a", "1"),
        ...
        public override DyeingPrintingAreaOutputModel GetEmptyModel()
        {
            ...
            {
                new DyeingPrintingAreaOutputProductionOrderModel(null,null,true,0,null,null,0,null,null,null,null,null,null,null,null,null,null,null,1,1,0,0,null,0,null,"0"),
        ...
        public DyeingPrintingAreaOutputModel GetWithDOModel()
        {
            ...
            {
                new DyeingPrintingAreaOutputProductionOrderModel("IM","TRANSIT",false,1,"a","e",1,"rr","1","as","test","unit","color","motif","mtr", "rem","a","a",2, 1,1,1, "name", 1, "a", "1"),
