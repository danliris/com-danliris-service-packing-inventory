...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils
{
    public class DyeingPrintingAreaInputProductionOrderDataUtil : BaseDataUtil<DyeingPrintingAreaInputProductionOrderRepository, DyeingPrintingAreaInputProductionOrderModel>
    {
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel("IM", 1, "no", "type", 1, "ins", "1", "bb", "ma", "unit", "col", "mot", "uuni", 2, 2, false, 1, 1, 1, "name", 1, "a", "1", 1, "a", 1, "a", 1, "a",DateTimeOffset.Now, "a", 1, "a", "a");
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel("SHIPPING", 1, "no", "type", 1, "ins", "1", "bb", "ma", "unit", "col", "mot", "uuni", 2, 2, false, 1, 1, 1, "name", 1, "a", "1", 1, "a", 1, "a", 1, "a",DateTimeOffset.Now, "a", 1, "a", "a");
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel("GUDANG JADI", 1, "no", "type", 1, "ins", "1", "bb", "ma", "unit", "col", "mot", "uuni", 2, 2, false, 1, 1, 1, "name", 1, "a", "1", 1, "a", 1, "a", 1, "a",DateTimeOffset.Now, "a", 1, "a", "a");
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel("TRANSIT", 1, "no", "type", 1, "ins", "1", "bb", "ma", "unit", "col", "mot", "uuni", 2, 2, false, 1, 1, 1, "name", 1, "a", "1", 1, "a", 1, "a", 1, "a", DateTimeOffset.Now, "a", 1, "a", "a");
        ...
        {
            var model = new DyeingPrintingAreaInputProductionOrderModel(null, 0, null, null, 0, null, null, null, null, null, null, null, null, 1, 1, true, 0, 0, 0, null, 0, null, "0", 0, null, 0, null, 0, null,DateTimeOffset.Now, null, 0, null, null);
