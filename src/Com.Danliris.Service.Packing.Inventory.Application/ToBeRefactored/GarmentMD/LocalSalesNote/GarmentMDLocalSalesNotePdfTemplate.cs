...
{
    public class GarmentMDLocalSalesNotePdfTemplate
    {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentMDLocalSalesNoteViewModel viewModel, GarmentLocalCoverLetterViewModel cl, Buyer buyer, int timeoffset)
        {
            const int MARGIN = 15;
    ...
    class GarmentShippingLocalSalesNotePdfTemplatePageEvent : PdfPageEventHelper
    {
        ...
        private GarmentMDLocalSalesNoteViewModel viewModel;
        ...
        public GarmentShippingLocalSalesNotePdfTemplatePageEvent(GarmentMDLocalSalesNoteViewModel viewModel, GarmentLocalCoverLetterViewModel cl, Buyer buyer, int timeoffset)
        {
