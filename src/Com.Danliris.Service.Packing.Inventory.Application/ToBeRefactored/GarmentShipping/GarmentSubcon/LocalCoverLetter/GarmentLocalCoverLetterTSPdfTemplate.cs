...
{
    public class GarmentLocalCoverLetterTSPdfTemplate
    {
        public MemoryStream GeneratePdfTemplate(GarmentLocalCoverLetterTSViewModel viewModel, GarmentShippingLocalSalesNoteTSViewModel salesNote, Buyer buyer, int timeoffset)
        {
            const int MARGIN = 20;
