...
{
    public class GarmentShippingLocalSalesNoteTSPdfTemplate
    {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentShippingLocalSalesNoteTSViewModel viewModel, GarmentLocalCoverLetterTSViewModel cl, Buyer buyer, int timeoffset)
        {
            ...
            tableFooter.AddCell(cellFooterContent1);
            cellFooterContent2.Phrase = new Phrase( "-", normal_font);
            tableFooter.AddCell(cellFooterContent2);
    ...
    class GarmentShippingLocalSalesNotePdfTemplatePageEvent : PdfPageEventHelper
    {
        ...
        private GarmentShippingLocalSalesNoteTSViewModel viewModel;
