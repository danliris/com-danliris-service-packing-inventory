...
{
    public class GarmentShippingExportSalesNotePdfTemplate
    {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentShippingExportSalesNoteViewModel viewModel, GarmentExportCoverLetterViewModel cl, Buyer buyer, int timeoffset)
        {
            const int MARGIN = 15;
            ...
            cellBodyCenter.Phrase = new Phrase("UNIT QTY", normal_font);
            tableBody.AddCell(cellBodyCenter);

            cellBodyCenter.Phrase = new Phrase("UNIT", normal_font);
            tableBody.AddCell(cellBodyCenter);
            ...
            cellBodyCenter.Phrase = new Phrase("UNIT PRICE IN US $", normal_font);
            cellBodyCenter.Colspan = 1;
            tableBody.AddCell(cellBodyCenter);

            cellBodyCenter.Phrase = new Phrase("TOTAL PRICE IN US $", normal_font);
            cellBodyCenter.Colspan = 1;
            tableBody.AddCell(cellBodyCenter);
            ...
            cellBodyRight.Phrase = new Phrase("TOTAL............................. $", normal_font);
            ...
            tableFooter.SetWidths(new float[] { 2f, 9f});

            PdfPCell cellFooterContent1 = new PdfPCell() { Border = Rectangle.NO_BORDER , HorizontalAlignment = Element.ALIGN_LEFT };
            ...
            string terbilang = NumberToTextEN.toWords(Math.Round(totalPrice, 2));
            cellFooterContent1.Phrase = (new Phrase("SAY               :", normal_font));
            tableFooter.AddCell(cellFooterContent1);
            cellFooterContent1.Phrase = (new Phrase("US DOLLARS " + terbilang + " ONLY", normal_font));
            tableFooter.AddCell(cellFooterContent1);

            cellFooterContent1.Phrase = new Phrase("SALES CONTRACT NO :", normal_font);
            tableFooter.AddCell(cellFooterContent1);
            ...
            //cellFooterContent3.Phrase = new Phrase("PEB NO         :", normal_font);
            //tableFooter.AddCell(cellFooterContent3);
            //cellFooterContent4.Phrase = new Phrase(cl == null ? "-" : cl.bcNo, normal_font);
            //tableFooter.AddCell(cellFooterContent4);

            cellFooterContent1.Phrase = new Phrase("TERM PARYMENT     :", normal_font);
            tableFooter.AddCell(cellFooterContent1);
            cellFooterContent2.Phrase = new Phrase("TT BEFORE DELIVERY", normal_font);
            tableFooter.AddCell(cellFooterContent2);

            //cellFooterContent3.Phrase = (new Phrase("PEB DATE       :", normal_font));
            //tableFooter.AddCell(cellFooterContent3);
            ...
            cellFooterContent11.Phrase = (new Phrase("NOTE     :", normal_font));
            ...
            document.Add(new Paragraph("PLEASE TT ABOVE PAYMENT TO OUR CORRESPONDANCE BANK AS FOLLOW :", normal_font));
            ...
            PdfPCell cellBodySignNoBorder2 = new PdfPCell() { Border = Rectangle.NO_BORDER, HorizontalAlignment = Element.ALIGN_RIGHT };
            ...
            cellBodySignNoBorder2.AddElement(new Phrase("MRS ADRIYANA DAMAYANTI", normal_font_underlined));
            cellBodySignNoBorder2.AddElement(new Phrase("(AUTHORIZED SIGNATURE)", normal_font));
    ...
    class GarmentShippingLocalSalesNotePdfTemplatePageEvent : PdfPageEventHelper
    {
        ...
        private GarmentShippingExportSalesNoteViewModel viewModel;
        ...
        public GarmentShippingLocalSalesNotePdfTemplatePageEvent(GarmentShippingExportSalesNoteViewModel viewModel, GarmentExportCoverLetterViewModel cl, Buyer buyer, int timeoffset)
        {
        ...
        public override void OnStartPage(PdfWriter writer, Document document)
        {
            ...
            cellHeaderContent2.AddElement(new Phrase("Sukoharjo, " + viewModel.date.GetValueOrDefault().ToOffset(new TimeSpan(timeoffset, 0, 0)).ToString("dd MMMM yyyy", new System.Globalization.CultureInfo("id-ID")), normal_font));
            cellHeaderContent2.AddElement(new Phrase("\n", normal_font));
            cellHeaderContent2.AddElement(new Phrase("MESSER : " +viewModel.buyer.Code + " - " + viewModel.buyer.Name + " - " + buyer.KaberType, normal_font));
            cellHeaderContent2.AddElement(new Phrase(buyer.Address, normal_font));
            tableHeader.AddCell(cellHeaderContent2);
            ...
            Paragraph title = new Paragraph("COMMERCIAL INVOICE", header_font_bold);
            title.Alignment = Element.ALIGN_CENTER;
            document.Add(title);

            Paragraph no = new Paragraph("NO. : " +viewModel.noteNo, header_font_bold);
            no.Alignment = Element.ALIGN_CENTER;
            document.Add(no);
