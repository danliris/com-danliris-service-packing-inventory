...
{
    public class GarmentShippingExportSalesContractViewModel : BaseViewModel, IValidatableObject
    {
        ...
        public ICollection<GarmentShippingExportSalesContractItemViewModel> items { get; set; }
