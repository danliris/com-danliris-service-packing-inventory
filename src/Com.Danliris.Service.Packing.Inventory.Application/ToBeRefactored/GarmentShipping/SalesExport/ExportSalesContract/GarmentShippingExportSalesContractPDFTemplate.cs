...
{
    public class GarmentShippingExportSalesContractPDFTemplate
    {
        public MemoryStream GeneratePdfTemplate(GarmentShippingExportSalesContractViewModel viewModel, int timeoffset)
        {
            const int MARGIN = 20;
