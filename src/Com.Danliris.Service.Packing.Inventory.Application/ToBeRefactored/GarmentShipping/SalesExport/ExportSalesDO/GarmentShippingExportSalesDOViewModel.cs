...
namespace Com.Danliris.Service.Packing.Inventory.Application.ToBeRefactored.GarmentShipping.SalesExport
{
    public class GarmentShippingExportSalesDOViewModel : BaseViewModel, IValidatableObject
    {
        ...
        public string exportSalesNoteNo { get; set; }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (string.IsNullOrEmpty(exportSalesNoteNo))
            {
                yield return new ValidationResult("No Nota Penjualan tidak boleh kosong", new List<string> { "exportSalesNoteNo" });
            }
