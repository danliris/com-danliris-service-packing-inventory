...
{
    public class GarmentExportCoverLetterPdfTemplate
    {
        public MemoryStream GeneratePdfTemplate(GarmentExportCoverLetterViewModel viewModel, GarmentShippingExportSalesNoteViewModel salesNote, Buyer buyer, int timeoffset)
        {
            const int MARGIN = 20;
            ...
            Paragraph no = new Paragraph(viewModel.exportCoverLetterNo, bold_font);
