...
{
    public class GarmentExportCoverLetterViewModel : BaseViewModel, IValidatableObject
    {
        ...
        {
            if (string.IsNullOrEmpty(noteNo) || exportSalesNoteId == 0)
            {
                yield return new ValidationResult("No Nota Penjualan tidak boleh kosong", new List<string> { "exportSalesNote" });
            }
