...
{
    public class GarmentShippingPaymentDispositionEMKLViewModel : BaseViewModel, IValidatableObject
    {
        ...
        public ICollection<GarmentShippingPaymentDispositionEMKLInvoiceDetailViewModel> invoiceDetails { get; set; }
