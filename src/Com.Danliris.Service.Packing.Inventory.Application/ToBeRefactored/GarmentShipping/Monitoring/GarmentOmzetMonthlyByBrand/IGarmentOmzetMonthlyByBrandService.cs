...
{
    public interface IGarmentOmzetMonthlyByBrandService
    {
        List<GarmentOmzetMonthlyByBrandViewModel> GetReportData(string buyerAgent, DateTime? dateFrom, DateTime? dateTo, int offset);
