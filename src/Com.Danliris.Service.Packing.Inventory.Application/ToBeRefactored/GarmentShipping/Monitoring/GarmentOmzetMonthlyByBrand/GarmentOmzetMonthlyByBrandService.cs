...
{
    public class GarmentOmzetMonthlyByBrandService : IGarmentOmzetMonthlyByBrandService
    {
        ...
        public GarmentOmzetMonthlyByBrandService(IServiceProvider serviceProvider)
        {
        ...
        public IQueryable<GarmentOmzetMonthlyByBrandViewModel> GetData(string buyerAgent, DateTime? dateFrom, DateTime? dateTo, int offset)
        {
            ...
            {
                queryitem = queryitem.Where(w => w.BuyerBrandName == buyerAgent);
            }
            ...
            var newQ = (from a in queryPL
                        ...
                        select new GarmentOmzetMonthlyByBrandListViewModel
                        {
                            InvoiceNo = a.InvoiceNo,
                            TruckingDate = a.TruckingDate,
                            BrandName = c.BuyerBrandName.TrimEnd(),
                            RO_Number = c.RONo,
                            ...
                            Quantity = c.Quantity,
                        }).OrderBy(o => o.BrandName).ThenBy(o => o.UnitCode).ThenBy(o => o.TruckingDate).ThenBy(o => o.InvoiceNo);              

            var garmentomzets = newQ.ToList()
                .GroupBy(gmtomzt => {
                    var buyeragent = gmtomzt.BrandName;
                    return buyeragent;
                })
                .Select(groupomzt => new GarmentOmzetMonthlyByBrandViewModel
                {
                    BrandName = groupomzt.Key,
                    Units = groupomzt
                        .GroupBy(ba => ba.UnitCode)
                        .Select(groupUnit => new GarmentOmzetMonthlyByBuyerBrandViewModel
                        {
        ...
        GarmentOmzetMonthlyByBrandDetailViewModel GetGarmentOmzet(GarmentOmzetMonthlyByBrandListViewModel go)
        {
            return new GarmentOmzetMonthlyByBrandDetailViewModel
            {
        ...
        public List<GarmentOmzetMonthlyByBrandViewModel> GetReportData(string buyerAgent, DateTime? dateFrom, DateTime? dateTo, int offset)
        {
            ...
            if (data != null && data.Count > 0)
            {
                ...
                foreach (var d in data)
                {
                    ...
                    foreach (var unit in d.Units)
                    {
                        ...
                        result.Rows.Add(null, null, null, null, null, null, null, null, unit.Quantities, null, unit.Amounts);
