            ...
            if (data != null && data.Count > 0)
            {
                ...
                foreach (var d in data)
                {
                    ...
                    foreach (var unit in d.Units)
                    {
                        ...
                        {
                            index++;
                            result.Rows.Add(index, d.BuyerName, unit.UnitCode, detail.InvoiceNo, detail.TruckingDate.ToString("MM/dd/yyyy", new CultureInfo("us-US")), detail.RO_Number, detail.ComodityName, detail.ComodityDesc, detail.Quantity, detail.UOMUnit, detail.Amount);
