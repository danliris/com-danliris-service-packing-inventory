...
{
    public interface IGarmentCreditAdviceMIIMonitoringService
    {
        ListResult<GarmentCreditAdviceMIIMonitoringViewModel> GetReportData(DateTime? dateFrom, DateTime? dateTo, int offset);
