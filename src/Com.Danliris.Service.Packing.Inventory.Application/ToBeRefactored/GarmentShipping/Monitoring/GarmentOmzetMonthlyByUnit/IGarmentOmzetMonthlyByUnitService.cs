...
{
    public interface IGarmentOmzetMonthlyByUnitService
    {
        List<GarmentOmzetMonthlyByUnitViewModel> GetReportData(string unit, DateTime? dateFrom, DateTime? dateTo, int offset);
