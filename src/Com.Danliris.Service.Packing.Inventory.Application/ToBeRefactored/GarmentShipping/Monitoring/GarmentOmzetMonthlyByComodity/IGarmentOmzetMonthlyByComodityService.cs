...
{
    public interface IGarmentOmzetMonthlyByComodityService
    {
        List<GarmentOmzetMonthlyByComodityViewModel> GetReportData(DateTime? dateFrom, DateTime? dateTo, int offset);
