            ...
            if (data != null && data.Count > 0)
            {
                ...
                foreach (var d in data)
                {
                    ...
                    foreach (var buyer in d.Buyers)
                    {
                        ...
                        {
                            index++;
                            result.Rows.Add(index, d.ComodityName, buyer.Buyer, detail.UnitCode, detail.InvoiceNo, detail.TruckingDate.ToString("MM/dd/yyyy", new CultureInfo("us-US")), detail.RO_Number, detail.ComodityName, detail.ComodityDesc, detail.Quantity, detail.UOMUnit, detail.Amount);
