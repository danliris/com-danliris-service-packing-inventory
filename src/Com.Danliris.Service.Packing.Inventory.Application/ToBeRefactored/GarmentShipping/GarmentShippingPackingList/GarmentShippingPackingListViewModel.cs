...
{
    public class GarmentShippingPackingListViewModel : BaseViewModel, IValidatableObject
    {
        #region Description
		...
		public ICollection<GarmentShippingPackingListItemViewModel> Items { get; set; }
        ...
        public ICollection<GarmentShippingPackingListMeasurementViewModel> Measurements { get; set; }
        ...
        public ICollection<GarmentShippingPackingListStatusActivityViewModel> StatusActivities { get; set; }
