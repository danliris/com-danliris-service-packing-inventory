...
{
    public class GarmentShippingPackingListPdfByOrderNoTemplate
    {
        private IIdentityProvider _identityProvider;

        public GarmentShippingPackingListPdfByOrderNoTemplate(IIdentityProvider identityProvider)
        {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentShippingPackingListViewModel viewModel, string fob, string cprice)
        {
            ...
            writer.PageEvent = new GarmentShippingPackingListPdfByOrderNoPageEvent(_identityProvider, viewModel);
    ...
    class GarmentShippingPackingListPdfByOrderNoPageEvent : PdfPageEventHelper
    {
        private IIdentityProvider identityProvider;
        private GarmentShippingPackingListViewModel viewModel;

        public GarmentShippingPackingListPdfByOrderNoPageEvent(IIdentityProvider identityProvider, GarmentShippingPackingListViewModel viewModel)
        {
