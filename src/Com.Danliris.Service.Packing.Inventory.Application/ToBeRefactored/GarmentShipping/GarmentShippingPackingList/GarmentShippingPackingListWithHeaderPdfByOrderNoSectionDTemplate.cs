...
{
    public class  GarmentShippingPackingListWithHeaderPdfByOrderNoSectionDTemplate
    {
        private IIdentityProvider _identityProvider;

        public GarmentShippingPackingListWithHeaderPdfByOrderNoSectionDTemplate(IIdentityProvider identityProvider)
        {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentShippingPackingListViewModel viewModel, string fob, string cprice)
        {
            ...
            writer.PageEvent = new GarmentShippingPackingListWithHederPdfByOrderNoSectionDPageEvent(_identityProvider, viewModel);
    ...
    class GarmentShippingPackingListWithHederPdfByOrderNoSectionDPageEvent : PdfPageEventHelper
    {
        private IIdentityProvider identityProvider;
        private GarmentShippingPackingListViewModel viewModel;

        public GarmentShippingPackingListWithHederPdfByOrderNoSectionDPageEvent(IIdentityProvider identityProvider, GarmentShippingPackingListViewModel viewModel)
        {
