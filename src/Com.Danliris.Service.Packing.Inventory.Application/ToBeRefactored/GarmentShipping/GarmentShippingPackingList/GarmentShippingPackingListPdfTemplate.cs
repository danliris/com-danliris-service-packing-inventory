...
{
    public class GarmentShippingPackingListPdfTemplate
    {
        private IIdentityProvider _identityProvider;

        public GarmentShippingPackingListPdfTemplate(IIdentityProvider identityProvider)
        {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentShippingPackingListViewModel viewModel, string fob, string cprice)
        {
            ...
            writer.PageEvent = new GarmentShippingPackingListPDFTemplatePageEvent(_identityProvider, viewModel);
    ...
    class GarmentShippingPackingListPDFTemplatePageEvent : PdfPageEventHelper
    {
        private IIdentityProvider identityProvider;
        private GarmentShippingPackingListViewModel viewModel;

        public GarmentShippingPackingListPDFTemplatePageEvent(IIdentityProvider identityProvider, GarmentShippingPackingListViewModel viewModel)
        {
