...
{
    public class GarmentShippingPackingListWithHeadeSectionDPdfTemplate
    {
        private IIdentityProvider _identityProvider;

        public GarmentShippingPackingListWithHeadeSectionDPdfTemplate(IIdentityProvider identityProvider)
        {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentShippingPackingListViewModel viewModel, string fob, string cprice)
        {
            ...
            writer.PageEvent = new GarmentShippingPackingListWithHeaderSectionDPDFTemplatePageEvent(_identityProvider, viewModel);
    ...
    class GarmentShippingPackingListWithHeaderSectionDPDFTemplatePageEvent : PdfPageEventHelper
    {
        private IIdentityProvider identityProvider;
        private GarmentShippingPackingListViewModel viewModel;

        public GarmentShippingPackingListWithHeaderSectionDPDFTemplatePageEvent(IIdentityProvider identityProvider, GarmentShippingPackingListViewModel viewModel)
        {
