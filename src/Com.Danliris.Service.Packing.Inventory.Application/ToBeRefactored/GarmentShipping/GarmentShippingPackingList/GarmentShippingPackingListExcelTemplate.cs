...
{
    public class GarmentShippingPackingListExcelTemplate
    {
        public IIdentityProvider _identityProvider;

        public GarmentShippingPackingListExcelTemplate(IIdentityProvider identityProvider)
        {
            _identityProvider = identityProvider;
        }

        public MemoryStream GenerateExcelTemplate(GarmentShippingPackingListViewModel viewModel, string fob, string cPrice)
        {
