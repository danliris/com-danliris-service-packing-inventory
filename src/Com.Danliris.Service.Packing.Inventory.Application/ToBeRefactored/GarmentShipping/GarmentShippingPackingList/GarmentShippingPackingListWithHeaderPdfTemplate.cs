...
{
    public class GarmentShippingPackingListWithHeadePdfTemplate
    {
        private IIdentityProvider _identityProvider;

        public GarmentShippingPackingListWithHeadePdfTemplate(IIdentityProvider identityProvider)
        {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentShippingPackingListViewModel viewModel, string fob, string cprice)
        {
            ...
            writer.PageEvent = new GarmentShippingPackingListWithHeaderPDFTemplatePageEvent(_identityProvider, viewModel);
    ...
    class GarmentShippingPackingListWithHeaderPDFTemplatePageEvent : PdfPageEventHelper
    {
        private IIdentityProvider identityProvider;
        private GarmentShippingPackingListViewModel viewModel;

        public GarmentShippingPackingListWithHeaderPDFTemplatePageEvent(IIdentityProvider identityProvider, GarmentShippingPackingListViewModel viewModel)
        {
