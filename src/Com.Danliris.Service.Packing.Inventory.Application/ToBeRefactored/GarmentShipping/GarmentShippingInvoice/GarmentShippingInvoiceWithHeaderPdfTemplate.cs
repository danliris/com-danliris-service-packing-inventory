...
namespace Com.Danliris.Service.Packing.Inventory.Application.ToBeRefactored.GarmentShipping.GarmentShippingInvoice
{
    ...
    class GarmentShippingInvoiceWithHeaderPdfTemplatePageEvent : iTextSharp.text.pdf.PdfPageEventHelper
    {
        ...
        public override void OnStartPage(PdfWriter writer, Document document)
        {
            ...
            #region SIGNATURE
            var printY = document.BottomMargin - 40;
            ...
            cb.MoveTo(signX - 110, signY - 2);
            cb.LineTo(signX + 10, signY - 2);
            cb.Stroke();
            ...
            var printY1 = document.BottomMargin - 10;
            var signX1 = document.LeftMargin + 10;
