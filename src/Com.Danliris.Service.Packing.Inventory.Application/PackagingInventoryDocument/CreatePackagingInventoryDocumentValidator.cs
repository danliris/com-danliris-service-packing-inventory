...
{
    public class CreatePackagingInventoryDocumentValidator : AbstractValidator<CreatePackagingInventoryDocumentViewModel>
    {
        public CreatePackagingInventoryDocumentValidator()
        {
        ...
        private bool ValidateComposition(CreatePackagingInventoryDocumentViewModel viewModel, string composition)
        {
        ...
        private bool ValidateConstruction(CreatePackagingInventoryDocumentViewModel viewModel, string construction)
        {
        ...
        private bool ValidateDesign(CreatePackagingInventoryDocumentViewModel viewModel, string design)
        {
            if(!string.IsNullOrWhiteSpace(viewModel.ProductType) && viewModel.ProductType.ToUpper() == "FABRIC")
            {
        ...
        private bool ValidateGrade(CreatePackagingInventoryDocumentViewModel viewModel, string grade)
        {
            if(!string.IsNullOrWhiteSpace(viewModel.ProductType) && (viewModel.ProductType.ToUpper() == "FABRIC" || viewModel.ProductType.ToUpper() == "GREIGE"))
            {
        ...
        private bool ValidateLot(CreatePackagingInventoryDocumentViewModel viewModel, string lot)
        {
        ...
        private bool ValidateWidth(CreatePackagingInventoryDocumentViewModel viewModel, string width)
        {
            if(!string.IsNullOrWhiteSpace(viewModel.ProductType) && (viewModel.ProductType.ToUpper() == "FABRIC" || viewModel.ProductType.ToUpper() == "GREIGE"))
            {
        ...
        private bool ValidateWovenType(CreatePackagingInventoryDocumentViewModel viewModel, string wovenType)
        {
        ...
        private bool ValidateYarnType1(CreatePackagingInventoryDocumentViewModel viewModel, string yarnType1)
        {
        ...
        private bool ValidateYarnType2(CreatePackagingInventoryDocumentViewModel viewModel, string yarnType2)
        {
            if(!string.IsNullOrWhiteSpace(viewModel.ProductType) && viewModel.ProductType.ToUpper() == "BENANG")
            {
