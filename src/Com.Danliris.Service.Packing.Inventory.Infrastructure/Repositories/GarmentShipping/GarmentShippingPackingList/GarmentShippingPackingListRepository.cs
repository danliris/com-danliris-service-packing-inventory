...
{
    public class GarmentShippingPackingListRepository : IGarmentShippingPackingListRepository
    {
        private const string UserAgent = "Repository";
        private readonly PackingInventoryDbContext _dbContext;
        private readonly IIdentityProvider _identityProvider;
        private readonly DbSet<GarmentShippingPackingListModel> _dbSet;

        public GarmentShippingPackingListRepository(PackingInventoryDbContext dbContext, IServiceProvider serviceProvider)
        {
            _dbContext = dbContext;
            _dbSet = dbContext.Set<GarmentShippingPackingListModel>();
        ...
        public Task<int> InsertAsync(GarmentShippingPackingListModel model)
        {
        ...
        public IQueryable<GarmentShippingPackingListModel> ReadAll()
        {
            return _dbSet
                .Include(i => i.Items)
                    .ThenInclude(i => i.Details)
        ...
        public Task<GarmentShippingPackingListModel> ReadByIdAsync(int id)
        {
            return _dbSet
                .Include(i => i.Items)
                    .ThenInclude(i => i.Details)
        ...
        public Task<int> UpdateAsync(int id, GarmentShippingPackingListModel model)
        {
		...
		public IQueryable<GarmentShippingPackingListModel> ReadNotUsedAsync()
		{
			return _dbSet
				.Where(s=>s.IsUsed == false);
		}

        public Task<GarmentShippingPackingListModel> ReadByInvoiceNoAsync(string no)
        {
            return _dbSet
                .Include(i => i.Items)
                    .ThenInclude(i => i.Details)
        ...
        public IQueryable<GarmentShippingPackingListModel> Query => _dbSet.AsQueryable();
