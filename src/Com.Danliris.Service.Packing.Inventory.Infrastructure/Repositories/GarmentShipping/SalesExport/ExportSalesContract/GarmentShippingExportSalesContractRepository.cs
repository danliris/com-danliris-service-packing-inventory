...
{
    public class GarmentShippingExportSalesContractRepository : IGarmentShippingExportSalesContractRepository
    {
        private const string UserAgent = "Repository";
        private readonly PackingInventoryDbContext _dbContext;
        private readonly IIdentityProvider _identityProvider;
        private readonly DbSet<GarmentShippingExportSalesContractModel> _dbSet;

        public GarmentShippingExportSalesContractRepository(PackingInventoryDbContext dbContext, IServiceProvider serviceProvider)
        {
            _dbContext = dbContext;
            _dbSet = dbContext.Set<GarmentShippingExportSalesContractModel>();
        ...
        public Task<int> InsertAsync(GarmentShippingExportSalesContractModel model)
        {
        ...
        public IQueryable<GarmentShippingExportSalesContractModel> ReadAll()
        {
            return _dbSet.AsNoTracking();
        }

        public Task<GarmentShippingExportSalesContractModel> ReadByIdAsync(int id)
        {
            return _dbSet
                .Include(i => i.Items)
        ...
        public Task<int> UpdateAsync(int id, GarmentShippingExportSalesContractModel model)
        {
