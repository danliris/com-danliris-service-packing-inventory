...
namespace Com.Danliris.Service.Packing.Inventory.Infrastructure.Repositories.GarmentShipping.CoverLetter
{
    public class GarmentCoverLetterRepository : IGarmentCoverLetterRepository
    {
        ...
        public Task<int> InsertAsync(GarmentCoverLetterModel model)
        {
        ...
        public IQueryable<GarmentCoverLetterModel> ReadAll()
        {
            return _dbSet.AsNoTracking();
        }

        public Task<GarmentCoverLetterModel> ReadByIdAsync(int id)
        {
            return _dbSet.FirstOrDefaultAsync(s => s.Id == id);
        }

        public async Task<int> UpdateAsync(int id, GarmentCoverLetterModel model)
        {
            ...
            modelToUpdate.SetOrder(model.Order, _identityProvider.Username, UserAgent);
