...
namespace Com.Danliris.Service.Packing.Inventory.Infrastructure.Repositories.DyeingPrintingStockOpname
{
    public class DyeingPrintingStockOpnameRepository : IDyeingPrintingStockOpnameRepository
    {
        ...
        //need improvement its only basic structure
        public async Task<int> UpdateStockOpnameData(int id, DyeingPrintingStockOpnameModel model, DyeingPrintingStockOpnameModel dbModel)
        {
            int result = 0;
            ...
            {
                item.FlagForCreate(_identityProvider.Username, UserAgent);
                dbModel.DyeingPrintingStockOpnameProductionOrders.Add(item);
