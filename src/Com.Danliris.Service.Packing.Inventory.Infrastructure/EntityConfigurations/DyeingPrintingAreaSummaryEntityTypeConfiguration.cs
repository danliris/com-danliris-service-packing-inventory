...
{
    public class DyeingPrintingAreaSummaryEntityTypeConfiguration : IEntityTypeConfiguration<DyeingPrintingAreaSummaryModel>
    {
        public void Configure(EntityTypeBuilder<DyeingPrintingAreaSummaryModel> builder)
        {
            builder
                .HasKey(s => s.Id);
