...
{
    public class InventoryDocumentPackingEntityTypeConfiguration : IEntityTypeConfiguration<InventoryDocumentPackingModel>
    {
        public void Configure(EntityTypeBuilder<InventoryDocumentPackingModel> configuration)
        {
            configuration
