...
{
    public class DyeingPrintingAreaInputEntityTypeConfiguration : IEntityTypeConfiguration<DyeingPrintingAreaInputModel>
    {
        public void Configure(EntityTypeBuilder<DyeingPrintingAreaInputModel> builder)
        {
            builder
                .HasKey(s => s.Id);
