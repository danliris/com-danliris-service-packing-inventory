...
{
    public class InventoryMovementPackingEntityTypeConfiguration : IEntityTypeConfiguration<InventoryMovementPackingModel>
    {
        public void Configure(EntityTypeBuilder<InventoryMovementPackingModel> configuration)
        {
            configuration
