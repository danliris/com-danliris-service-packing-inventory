...
namespace Com.Danliris.Service.Packing.Inventory.Infrastructure.EntityConfigurations.GarmentShipping.AmendLetterOfCredit
{
    public class GarmentAmendLetterOfCreditEntityTypeConfiguration : IEntityTypeConfiguration<GarmentShippingAmendLetterOfCreditModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingAmendLetterOfCreditModel> builder)
        {
            /* StandardEntity */
