...
{
    public class GarmentShippingPackingListItemEntityTypeConfiguration : IEntityTypeConfiguration<GarmentShippingPackingListItemModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingPackingListItemModel> builder)
        {
            /* StandardEntity */
            ...
            builder
                .Property(s => s.ExpenditureGoodNo)
                .HasMaxLength(50);
