...
{
    public class GarmentShippingPackingListMeasurementEntityTypeConfiguration : IEntityTypeConfiguration<GarmentShippingPackingListMeasurementModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingPackingListMeasurementModel> builder)
        {
            /* StandardEntity */
