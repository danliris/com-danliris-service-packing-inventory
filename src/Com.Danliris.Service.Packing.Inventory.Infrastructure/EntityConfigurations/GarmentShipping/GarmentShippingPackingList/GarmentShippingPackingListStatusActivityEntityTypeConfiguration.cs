...
{
    class GarmentShippingPackingListStatusActivityEntityTypeConfiguration : IEntityTypeConfiguration<GarmentShippingPackingListStatusActivityModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingPackingListStatusActivityModel> builder)
        {
