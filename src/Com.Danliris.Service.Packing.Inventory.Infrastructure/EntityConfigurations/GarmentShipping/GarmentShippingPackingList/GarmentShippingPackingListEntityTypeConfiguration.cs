...
{
    public class GarmentShippingPackingListEntityTypeConfiguration : IEntityTypeConfiguration<GarmentShippingPackingListModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingPackingListModel> builder)
        {
            /* StandardEntity */
