...
{
    public class GarmentShippingLocalSalesContractConfig : IEntityTypeConfiguration<GarmentShippingLocalSalesContractModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingLocalSalesContractModel> builder)
        {
            /* StandardEntity */
            ...
            builder
                 .HasMany(h => h.Items)
                .WithOne()
                .HasForeignKey(f => f.LocalSalesContractId);
        }
    }
}
