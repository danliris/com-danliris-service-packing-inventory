...
{
    public class GarmentMDLocalSalesContractConfig : IEntityTypeConfiguration<GarmentMDLocalSalesContractModel>
    {
        public void Configure(EntityTypeBuilder<GarmentMDLocalSalesContractModel> builder)
        {
            /* StandardEntity */
