...
{
    public class GarmentShippingVBPaymentInvoiceConfig : IEntityTypeConfiguration<GarmentShippingVBPaymentInvoiceModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingVBPaymentInvoiceModel> builder)
        {
            /* StandardEntity */
            ...
            builder.Property(s => s.InvoiceNo).HasMaxLength(128);
        }
    }
}
