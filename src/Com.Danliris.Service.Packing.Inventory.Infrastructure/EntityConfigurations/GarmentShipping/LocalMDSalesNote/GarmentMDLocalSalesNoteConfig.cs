...
{
    public class GarmentMDLocalSalesNoteConfig : IEntityTypeConfiguration<GarmentMDLocalSalesNoteModel>
    {
        public void Configure(EntityTypeBuilder<GarmentMDLocalSalesNoteModel> builder)
        {
            /* StandardEntity */
