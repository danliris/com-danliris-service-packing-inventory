...
{
    public class GarmentReceiptSubconPackingListItemEntityTypeConfiguration : IEntityTypeConfiguration<GarmentReceiptSubconPackingListItemModel>
    {
        public void Configure(EntityTypeBuilder<GarmentReceiptSubconPackingListItemModel> builder)
        {
            /* StandardEntity */
