...
{
    public class GarmentCoverLetterEntityTypeConfiguration : IEntityTypeConfiguration<GarmentCoverLetterModel>
    {
        public void Configure(EntityTypeBuilder<GarmentCoverLetterModel> builder)
        {
            /* StandardEntity */
            ...
            builder.Property(s => s.Order).HasMaxLength(250);
