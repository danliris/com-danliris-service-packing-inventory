...
{
    public class GarmentShippingPaymentDispositionPaymentDetailConfig : IEntityTypeConfiguration<GarmentShippingPaymentDispositionPaymentDetailModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingPaymentDispositionPaymentDetailModel> builder)
        {
            /* StandardEntity */
            ...
            builder
                .Property(s => s.PaymentDescription)
                .HasMaxLength(1000);
        }
    }
}
