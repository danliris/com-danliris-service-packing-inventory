...
{
    public class GarmentShippingPaymentDispositionUnitChargeConfig : IEntityTypeConfiguration<GarmentShippingPaymentDispositionUnitChargeModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingPaymentDispositionUnitChargeModel> builder)
        {
            /* StandardEntity */
