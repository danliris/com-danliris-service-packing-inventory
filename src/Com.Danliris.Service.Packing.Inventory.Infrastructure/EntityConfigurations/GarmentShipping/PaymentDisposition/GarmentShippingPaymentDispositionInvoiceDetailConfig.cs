...
{
    public class GarmentShippingPaymentDispositionInvoiceDetailConfig : IEntityTypeConfiguration<GarmentShippingPaymentDispositionInvoiceDetailModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingPaymentDispositionInvoiceDetailModel> builder)
        {
            /* StandardEntity */
