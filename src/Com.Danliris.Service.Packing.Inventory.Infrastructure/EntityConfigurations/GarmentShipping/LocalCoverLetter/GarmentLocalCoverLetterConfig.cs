...
namespace Com.Danliris.Service.Packing.Inventory.Infrastructure.EntityConfigurations.GarmentShipping.LocalCoverLetter
{
    public class GarmentLocalCoverLetterConfig : IEntityTypeConfiguration<GarmentShippingLocalCoverLetterModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingLocalCoverLetterModel> builder)
        {
            /* StandardEntity */
