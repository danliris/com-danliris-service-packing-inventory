...
{
    public class GarmentShippingExportSalesContractItemConfig : IEntityTypeConfiguration<GarmentShippingExportSalesContractItemModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingExportSalesContractItemModel> builder)
        {
            /* StandardEntity */
