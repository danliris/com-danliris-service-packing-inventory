...
{
    public class GarmentShippingExportSalesDOItemConfig : IEntityTypeConfiguration<GarmentShippingLeftOverExportSalesDOItemModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingLeftOverExportSalesDOItemModel> builder)
        {
            /* StandardEntity */
