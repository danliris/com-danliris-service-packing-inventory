...
{
    public class GarmentShippingExportSalesNoteConfig : IEntityTypeConfiguration<GarmentShippingExportSalesNoteModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingExportSalesNoteModel> builder)
        {
            /* StandardEntity */
            ...
            builder
                 .HasMany(h => h.Items)
                .WithOne()
                .HasForeignKey(f => f.ExportSalesNoteId);
