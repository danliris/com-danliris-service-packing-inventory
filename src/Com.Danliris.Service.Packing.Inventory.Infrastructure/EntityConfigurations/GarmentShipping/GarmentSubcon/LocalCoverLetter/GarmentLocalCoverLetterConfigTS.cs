...
namespace Com.Danliris.Service.Packing.Inventory.Infrastructure.EntityConfigurations.GarmentShipping.LocalCoverLetterTS
{
    public class GarmentLocalCoverLetterConfigTS : IEntityTypeConfiguration<GarmentShippingLocalCoverLetterTSModel>
    {
        public void Configure(EntityTypeBuilder<GarmentShippingLocalCoverLetterTSModel> builder)
        {
            /* StandardEntity */
