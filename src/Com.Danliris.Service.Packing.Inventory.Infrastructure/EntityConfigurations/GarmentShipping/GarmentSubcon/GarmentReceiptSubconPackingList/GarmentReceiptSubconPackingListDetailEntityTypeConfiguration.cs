...
{
    public class GarmentReceiptSubconPackingListDetailEntityTypeConfiguration : IEntityTypeConfiguration<GarmentReceiptSubconPackingListDetailModel>
    {
        public void Configure(EntityTypeBuilder<GarmentReceiptSubconPackingListDetailModel> builder)
        {
            /* StandardEntity */
