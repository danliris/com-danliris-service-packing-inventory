...
{
    public partial class AddTableGarmentReceiptSubconLocalCoverLetters : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "GarmentReceiptSubconLocalCoverLetters",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GarmentReceiptSubconLocalCoverLetters", x => x.Id);
                });
        }
