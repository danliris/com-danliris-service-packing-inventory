...
{
    public class GarmentReceiptSubconPackingListDetailModel : StandardEntity
    {
        ...
        public ICollection<GarmentReceiptSubconPackingListDetailSizeModel> Sizes { get; private set; }

        public GarmentReceiptSubconPackingListDetailModel()
        {
            Sizes = new List<GarmentReceiptSubconPackingListDetailSizeModel>();
        }

        public GarmentReceiptSubconPackingListDetailModel(double carton1, double carton2, string style, double cartonQuantity, double quantityPCS, double totalQuantity, double length, double width, double height, double grossWeight, double netWeight, double netNetWeight, ICollection<GarmentReceiptSubconPackingListDetailSizeModel> sizes, int index)
        {
            Carton1 = carton1;
            Carton2 = carton2;
            Style = style;
