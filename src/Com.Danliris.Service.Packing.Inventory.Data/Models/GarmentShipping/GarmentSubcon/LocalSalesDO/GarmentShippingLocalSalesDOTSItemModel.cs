...
{
    public class GarmentShippingLocalSalesDOTSItemModel : StandardEntity
    {
        ...
        public GarmentShippingLocalSalesDOTSItemModel(int localSalesDOId, int localSalesNoteItemId,/* int productId, string productCode, string productName,*/ string description, double quantity, int uomId, string uomUnit, double packQuantity, int packUomId, string packUomUnit, double grossWeight, double nettWeight, string invoiceNo)
        {
