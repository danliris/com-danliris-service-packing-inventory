...
namespace Com.Danliris.Service.Packing.Inventory.Data.Models.Garmentshipping.LocalSalesDOTS
{
    public class GarmentShippingLocalSalesDOTSModel : StandardEntity
    {
        ...
        public ICollection<GarmentShippingLocalSalesDOTSItemModel> Items { get; set; }
        public GarmentShippingLocalSalesDOTSModel(string localSalesDONo, string localSalesNoteNo, int localSalesNoteId, DateTimeOffset date, int buyerId, string buyerCode, string buyerName, string to, string storageDivision, string remark, ICollection<GarmentShippingLocalSalesDOTSItemModel> items)
        {
        ...
        public GarmentShippingLocalSalesDOTSModel()
        {
        }
