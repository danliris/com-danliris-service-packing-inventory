...
namespace Com.Danliris.Service.Packing.Inventory.Data.Models.Garmentshipping.LocalCoverLetterTS
{
    public class GarmentShippingLocalCoverLetterTSModel : StandardEntity
    {
        ...
        public GarmentShippingLocalCoverLetterTSModel()
        {
        }

        public GarmentShippingLocalCoverLetterTSModel(int localSalesNoteId, string noteNo, string localCoverLetterNo, DateTimeOffset date, int buyerId, string buyerCode, string buyerName, string buyerAdddress, string remark, string bcNo, DateTimeOffset bcDate, string truck, string plateNumber, string driver, int shippingStaffId, string shippingStaffName)
        {
