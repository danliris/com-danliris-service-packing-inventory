...
{
    public class GarmentShippingPackingListMeasurementModel : StandardEntity
    {
        ...
        public GarmentShippingPackingListMeasurementModel()
        {
        }

        public GarmentShippingPackingListMeasurementModel(double length, double width, double height, double cartonsQuantity, string createdBy)
        {
            Length = length;
            Width = width;
            Height = height;
