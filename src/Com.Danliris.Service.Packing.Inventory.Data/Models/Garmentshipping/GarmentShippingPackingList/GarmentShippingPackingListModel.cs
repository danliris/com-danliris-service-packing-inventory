...
namespace Com.Danliris.Service.Packing.Inventory.Data.Models.Garmentshipping.GarmentShippingPackingList
{
    public class GarmentShippingPackingListModel : StandardEntity
    {
        #region Description
		...
		public ICollection<GarmentShippingPackingListItemModel> Items { get; private set; }
        ...
        public ICollection<GarmentShippingPackingListMeasurementModel> Measurements { get; private set; }
        ...
        public GarmentShippingPackingListStatusEnum Status { get; private set; }
        public ICollection<GarmentShippingPackingListStatusActivityModel> StatusActivities { get; private set; }
        ...
        public GarmentShippingPackingListModel()
        {
            Items = new HashSet<GarmentShippingPackingListItemModel>();
            Measurements = new HashSet<GarmentShippingPackingListMeasurementModel>();
            StatusActivities = new HashSet<GarmentShippingPackingListStatusActivityModel>();
        }

        public GarmentShippingPackingListModel(string invoiceNo, string packingListType, string invoiceType, int sectionId, string sectionCode, DateTimeOffset date, string paymentTerm, string lCNo, DateTimeOffset lCDate, string issuedBy, int buyerAgentId, string buyerAgentCode, string buyerAgentName, string destination, string finalDestination, string shipmentMode, DateTimeOffset truckingDate, DateTimeOffset truckingEstimationDate, DateTimeOffset exportEstimationDate, bool omzet, bool accounting, string fabricCountryOrigin, string fabricComposition, string remarkMd, ICollection<GarmentShippingPackingListItemModel> items, double grossWeight, double nettWeight, double netNetWeight, double totalCartons, ICollection<GarmentShippingPackingListMeasurementModel> measurements, string sayUnit, string shippingMark, string sideMark, string remark, string shippingMarkImagePath, string sideMarkImagePath, string remarkImagePath, bool isUsed, bool isPosted, int shippingStaffId, string shippingStaffName, GarmentShippingPackingListStatusEnum status, string description, bool isCostStructured, string otherCommodity, bool isShipping, bool isSampleDelivered, bool isSampleExpenditureGood, string sampleRemarkMd)
        {
            InvoiceNo = invoiceNo;
        ...
        public void SetStatus(GarmentShippingPackingListStatusEnum status, string userName, string userAgent)
        {
            if (Status != status)
            {
                Status = status;
