...
{
    public class GarmentShippingPackingListDetailModel : StandardEntity
    {
        ...
        public ICollection<GarmentShippingPackingListDetailSizeModel> Sizes { get; private set; }

        public GarmentShippingPackingListDetailModel()
        {
            Sizes = new List<GarmentShippingPackingListDetailSizeModel>();
        }

        public GarmentShippingPackingListDetailModel(double carton1, double carton2, string style, string colour, double cartonQuantity, double quantityPCS, double totalQuantity, double length, double width, double height, double grossWeight, double netWeight, double netNetWeight, ICollection<GarmentShippingPackingListDetailSizeModel> sizes, int index)
        {
            Carton1 = carton1;
            Carton2 = carton2;
            Style = style;
