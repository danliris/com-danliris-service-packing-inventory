...
{
    public class GarmentShippingPackingListItemModel : StandardEntity
    {
        ...
        public ICollection<GarmentShippingPackingListDetailModel> Details { get; private set; }

        public GarmentShippingPackingListItemModel()
        {
            Details = new HashSet<GarmentShippingPackingListDetailModel>();
        }

        public GarmentShippingPackingListItemModel(string expenditureGoodNo, string rONo, string sCNo, int buyerBrandId, string buyerBrandName, int comodityId, string comodityCode, string comodityName, string comodityDescription, string marketingName, double quantity, int uomId, string uomUnit, double priceRO, double price, double priceFob, double priceCmt, double amount, string valas, int unitId, string unitCode, string article, string orderNo, string description, string descriptionMd, string remarks, string roType, ICollection<GarmentShippingPackingListDetailModel> details)
        {
        ...
        public void SetExpenditureGoodNo(string expenditureGoodNo, string userName, string userAgent)
        {
            if (ExpenditureGoodNo != expenditureGoodNo)
            {
                ExpenditureGoodNo = expenditureGoodNo;
