...
{
    public class GarmentShippingPackingListDetailSizeModel : StandardEntity
    {
        ...
        public GarmentShippingPackingListDetailSizeModel()
        {
        }

        public GarmentShippingPackingListDetailSizeModel(int sizeId, string size, int sizeIdx, double quantity)
        {
            SizeId = sizeId;
            Size = size;
            SizeIdx = sizeIdx;
