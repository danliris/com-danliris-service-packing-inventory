...
{
    public class GarmentCoverLetterModel : StandardEntity
    {
        ...
        public void SetOrder(string order, string userName, string userAgent)
        {
            if (Order != order)
            {
                Order = order;
        ...
        public void SetShippingStaff(string shippingStaff, string userName, string userAgent)
        {
            if (ShippingStaff != shippingStaff)
            {
                ShippingStaff = shippingStaff;
                this.FlagForUpdate(userName, userAgent);
            }
