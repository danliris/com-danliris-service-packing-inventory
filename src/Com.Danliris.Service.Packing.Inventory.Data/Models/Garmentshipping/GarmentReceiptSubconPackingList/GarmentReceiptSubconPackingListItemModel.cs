...
{
    public class GarmentReceiptSubconPackingListItemModel : StandardEntity
    {
        ...
        public ICollection<GarmentReceiptSubconPackingListDetailModel> Details { get; private set; }

        public GarmentReceiptSubconPackingListItemModel()
        {
        ...
        public void SetPackingOutNo(string packingOutNo, string userName, string userAgent)
        {
            if (PackingOutNo != packingOutNo)
            {
                PackingOutNo = packingOutNo;
                this.FlagForUpdate(userName, userAgent);
            }
